...
Public Class Form_pedidos_aceptados
    ...
    Private Sub Form_pedidos_aceptados_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_menu_principal.WindowState = FormWindowState.Normal
    End Sub

    Private Sub Form_pedidos_aceptados_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_pedidos_aceptados_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Sub busqueda()
        ...
        Me.Enabled = False
        fecha()
        consulta_busqueda = "select  n_pedidos_vendedor as 'NRO.', condiciones as 'CONDIC.', fecha_venta as 'FECHA', pedidos_vendedor.rut_cliente as 'RUT CLIENTE', direccion_cliente as 'SUCURSAL', subtotal as 'SUBTOTAL', porcentaje_desc '%', total as 'TOTAL', nombre_usuario as 'VENDEDOR', estado as 'ESTADO' from pedidos_vendedor, usuarios, clientes  where estado='ACEPTADO' and fecha_venta >='" & (mifecha2) & "' and fecha_venta <= '" & (mifecha4) & "' and pedidos_vendedor.usuario_responsable=usuarios.rut_usuario and pedidos_vendedor.codigo_cliente=clientes.cod_cliente "
