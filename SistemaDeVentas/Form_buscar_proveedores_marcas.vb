...
Public Class Form_buscar_proveedores_marcas
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        ...
        Else
            ...
            Form_proveedores_marcas.txt_rut.Text = codigo
    ...
    Sub MOSTRAR_DATOS_PROVEEDOR()
        ...
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
            Form_proveedores_marcas.txt_rut.Text = DS.Tables(DT.TableName).Rows(0).Item("rut_proveedor")
            'Form_proveedores_marcas.txt_nombre.Text = DS.Tables(DT.TableName).Rows(0).Item("nombre_proveedor")
        End If
        conexion.Close()


        Form_proveedores_marcas.mostrar_malla_forma_de_pago()
    ...
    Private Sub Form_buscar_proveedores_marcas_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Form_proveedores_marcas.WindowState = FormWindowState.Normal
        Form_proveedores_marcas.Enabled = True
    End Sub
