...
Public Class Form_inventario
    ...
    Dim fecha_inventario_inicial As String
    Private Sub Form_inventario_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_menu_principal.WindowState = FormWindowState.Normal
    End Sub

    Private Sub Form_inventario_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_inventario_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        inventario_inicial()
        dtp_desde.Text = fecha_inventario_inicial
        txt_productos.Text = ""
        txt_total.Text = ""
        Me.Width = 1024
        Me.Height = 728
    ...
    Sub inventario_inicial()
        ...
        If DS2.Tables(DT2.TableName).Rows.Count > 0 Then
            fecha_inventario_inicial = DS2.Tables(DT2.TableName).Rows(0).Item("inventario_inicial")
        End If
    End Sub
    ...
    Sub mostrar_malla_inventario()
        ...
        SC.CommandText = "select * from productos, familia where productos.familia=familia.codigo and cantidad >= 1 group by cod_producto"
        ...
        grilla_inventario.Columns.Add("", "COSTO")
        grilla_inventario.Columns.Add("", "PRECIO")
        grilla_inventario.Columns.Add("", "CANTIDAD")
        grilla_inventario.Columns.Add("", "TOTAL")
        grilla_inventario.Columns.Add("", "ULT. COMP.")
                                                   ...
                                                   DS.Tables(DT.TableName).Rows(i).Item("costo"),
                                                    DS.Tables(DT.TableName).Rows(i).Item("precio"),
                                                     DS.Tables(DT.TableName).Rows(i).Item("cantidad"),
                                                      Int(DS.Tables(DT.TableName).Rows(i).Item("costo")) * Int(DS.Tables(DT.TableName).Rows(i).Item("cantidad")),
        ...
        If grilla_inventario.Rows.Count <> 0 Then
            ...
            grilla_inventario.Columns(7).Width = 100
            grilla_inventario.Columns(8).Width = 100
            grilla_inventario.Columns(9).Width = 100
            ...
            grilla_inventario.Columns(6).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            grilla_inventario.Columns(7).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            grilla_inventario.Columns(8).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            grilla_inventario.Columns(9).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
        End If
    End Sub
