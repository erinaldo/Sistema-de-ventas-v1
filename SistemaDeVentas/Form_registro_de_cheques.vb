...
Public Class Form_registro_de_cheques
    ...
    Dim impresora_ticket_registro_cheques As String
    ...
    Sub mostrar_impresora()
        ...
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
            impresora_ticket_registro_cheques = DS.Tables(DT.TableName).Rows(0).Item("ticket_registro_cheques")
        End If
        conexion.Close()
    End Sub
    ...
    Private Sub btn_imprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_imprimir.Click
        ...
        If valormensaje = vbYes Then
            ...
            With Pd.PrinterSettings
                ...
                .PrinterName = impresora_ticket_registro_cheques
