...
Public Class Form_pedidos
    ...
    Sub grabar_pedido()
        ...
        'conexion.Open()
        SC.Connection = conexion
        SC.CommandText = "insert into pedido (codigo_pedido, rut_cliente, nombre_cliente, telefono_cliente, abono, fecha_pedido, usuario_responsable, hora) values('" & (txt_codigo_pedido.Text) & "', '-','-','-', '0', '" & (Form_menu_principal.dtp_fecha.Text) & "','" & (miusuario) & "', '" & (Form_menu_principal.lbl_hora.Text) & "')"
        DA.SelectCommand = SC
        DA.Fill(DT)
        'conexion.Close()
    End Sub
    ...
    Private Sub Combo_proveedor_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Combo_proveedor.SelectedIndexChanged
        ...
        dtp_fecha_llegada.Value = Form_menu_principal.dtp_fecha.Value
