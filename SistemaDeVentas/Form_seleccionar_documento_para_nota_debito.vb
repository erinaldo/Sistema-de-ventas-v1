...
Public Class Form_seleccionar_documento_para_nota_debito
        ...
        If combo_documento.Text = "NOTA DE CREDITO" Then
            ...
            If DS.Tables(DT.TableName).Rows.Count > 0 Then
                ...
                For i = 0 To DS.Tables(DT.TableName).Rows.Count - 1
                    ...
                    If varnombre Like "GUIA" Then
                        VarDescuento = 0
                        VarValorUnitario = DS.Tables(DT.TableName).Rows(i).Item("detalle_total")
                        VarTotal = DS.Tables(DT.TableName).Rows(i).Item("detalle_total")
                    End If
                    ...
                    Form_nota_de_debito.grilla_detalle_venta.Rows.Add(VarCodProducto,
                            varnombre,
                            vartecnico,
                            VarValorUnitario,
                            VarCantidad,
                ...
                If Form_nota_de_debito.grilla_detalle_venta.Rows.Count <> 0 Then
                    If Form_nota_de_debito.grilla_detalle_venta.Columns(0).Width = 85 Then
                        Form_nota_de_debito.grilla_detalle_venta.Columns(0).Width = 86
                    Else
                        Form_nota_de_debito.grilla_detalle_venta.Columns(0).Width = 85
                    End If
                    Form_nota_de_debito.grilla_detalle_venta.Columns(1).Width = 220
                    Form_nota_de_debito.grilla_detalle_venta.Columns(2).Width = 195
                    Form_nota_de_debito.grilla_detalle_venta.Columns(3).Width = 85
                    Form_nota_de_debito.grilla_detalle_venta.Columns(4).Width = 85
                    Form_nota_de_debito.grilla_detalle_venta.Columns(5).Width = 85
                    Form_nota_de_debito.grilla_detalle_venta.Columns(6).Width = 85
                    Form_nota_de_debito.grilla_detalle_venta.Columns(7).Width = 85
                    Form_nota_de_debito.grilla_detalle_venta.Columns(8).Width = 36
                    Form_nota_de_debito.grilla_detalle_venta.Columns(9).Width = 85
                    Form_nota_de_debito.grilla_detalle_venta.Columns(10).Width = 85
                End If
            End If
            Form_nota_de_debito.txt_porcentaje_desc.Text = "0"
