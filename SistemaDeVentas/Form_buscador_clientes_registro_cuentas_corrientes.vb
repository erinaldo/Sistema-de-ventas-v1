...
Public Class Form_buscador_clientes_registro_cuentas_corrientes
    ...
    Private Sub Form_buscar_clientes_registro_cuentas_corrientes_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub Form_buscar_clientes_registro_cuentas_corrientes_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_clientes_registro_cuentas_corrientes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        ...
        Else
            ...
            Form_registro_cuentas_corrientes.txt_rut.Text = codigo
    ...
    Sub mostrar_datos_clientes()
        ...
        If DS.Tables(DT.TableName).Rows.Count = 1 Then
            ...
            'Form_registro_cuentas_corrientes.Combo_orden.Text = DS.Tables(DT.TableName).Rows(0).Item("orden_de_compra")
            ...
            Form_registro_cuentas_corrientes.txt_email.Text = DS.Tables(DT.TableName).Rows(0).Item("email_cliente")
            Form_registro_cuentas_corrientes.txt_email_dos.Text = DS.Tables(DT.TableName).Rows(0).Item("email_cliente_dos")
            Form_registro_cuentas_corrientes.txt_comuna.Text = DS.Tables(DT.TableName).Rows(0).Item("comuna_cliente")
            Form_registro_cuentas_corrientes.txt_ciudad.Text = DS.Tables(DT.TableName).Rows(0).Item("ciudad_cliente")
            Form_registro_cuentas_corrientes.txt_giro.Text = DS.Tables(DT.TableName).Rows(0).Item("giro_cliente")
            Form_registro_cuentas_corrientes.txt_dscto1.Text = DS.Tables(DT.TableName).Rows(0).Item("descuento_1")
            ...
            Form_registro_cuentas_corrientes.txt_cuenta.Text = DS.Tables(DT.TableName).Rows(0).Item("estado_cuenta")
            Form_registro_cuentas_corrientes.Combo_cuenta.Text = DS.Tables(DT.TableName).Rows(0).Item("estado_cuenta")
