...
Public Class Form_registro_cuentas_corrientes
    ...
    Private Sub txt_pagare_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        e.KeyChar = e.KeyChar.ToString.ToUpper
        If e.KeyChar = ";" Then
            e.KeyChar = ""
        End If
    ...
    Private Sub txt_pagare_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub txt_telefono_dos_TextChanged(sender As Object, e As EventArgs) Handles txt_telefono_dos.TextChanged

    End Sub

    Private Sub txt_telefono_dos_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_telefono_dos.KeyPress
