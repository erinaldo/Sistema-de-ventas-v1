...
Public Class Form_buscador_proveedores_registro_facturas
    Dim consulta_busqueda As String
    Private Sub Form_buscar_proveedores_registro_facturas_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed

        If buscar_proveedores = "1" Then
            Form_registro_de_facturas.WindowState = FormWindowState.Normal
            Form_registro_de_facturas.Enabled = True
        End If

        If buscar_proveedores = "2" Then
            Form_registro_de_facturas_deuda.WindowState = FormWindowState.Normal
            Form_registro_de_facturas_deuda.Enabled = True
        End If


    End Sub

    Private Sub Form_buscar_proveedores_registro_facturas_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_proveedores_registro_facturas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        If buscar_proveedores = "1" Then
            ...
            If migrilla.Rows.Count <= 0 Then
                Form_registro_de_facturas.txt_rut_proveedor.Focus()
                Me.Close()
            Else
                codigo = migrilla.CurrentRow.Cells(0).Value
                Form_registro_de_facturas.txt_rut_proveedor.Text = codigo
                Form_registro_de_facturas.mostrar_malla()
                Form_registro_de_facturas.calcular_totales()
                Form_registro_de_facturas.txt_nro_factura.Text = ""
                Form_registro_de_facturas.Check_folio.Checked = False
                Form_registro_de_facturas.Check_periodo_tributario.Checked = False
                Form_registro_de_facturas.Check_rut.Checked = False
                Me.Close()
            End If
        End If
        ...
        If buscar_proveedores = "2" Then
            Dim codigo As String
            If migrilla.Rows.Count <= 0 Then
                Form_registro_de_facturas_deuda.txt_rut_proveedor.Focus()
                Me.Close()
            Else
                codigo = migrilla.CurrentRow.Cells(0).Value
                Form_registro_de_facturas_deuda.txt_rut_proveedor.Text = codigo
                Form_registro_de_facturas_deuda.mostrar()
                Form_registro_de_facturas_deuda.calcular_totales()
                Form_registro_de_facturas_deuda.txt_nro_factura.Text = ""
                Form_registro_de_facturas_deuda.Check_folio.Checked = False
                Form_registro_de_facturas_deuda.Check_periodo_tributario.Checked = False
                Form_registro_de_facturas_deuda.Check_rut.Checked = False
                Me.Close()
            End If
        End If
    End Sub
