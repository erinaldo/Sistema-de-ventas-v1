...
Public Class Form_buscador_clientes_guias_traslado
    ...
    Private Sub Form_buscar_clientes_guias_traslado_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        If Form_mensaje_clientes.Visible = True Then
            Form_guias_traslado.Enabled = False
        Else
            Form_guias_traslado.Enabled = True
        End If

        If Form_guias_traslado.combo_venta.Text = "BOLETA" Then
            Form_guias_traslado.txt_codigo.Focus()
        End If

        If Form_guias_traslado.combo_venta.Text = "BOLETA DE CREDITO" Then
            Form_guias_traslado.txt_codigo.Focus()
        End If

        If Form_guias_traslado.combo_venta.Text = "COTIZACION" Then
            Form_guias_traslado.txt_codigo.Focus()
        End If

        If Form_guias_traslado.combo_venta.Text = "FACTURA" Then
            Form_guias_traslado.txt_rut_retira.Focus()
        End If

        If Form_guias_traslado.combo_venta.Text = "FACTURA DE CREDITO" Then
            Form_guias_traslado.txt_rut_retira.Focus()
        End If

        If Form_guias_traslado.combo_venta.Text = "GUIA" Then
            Form_guias_traslado.txt_rut_retira.Focus()
        End If
        ' Form_venta.Enabled = True
    End Sub

    Private Sub Form_buscar_clientes_guias_traslado_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_clientes_guias_traslado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        ...
        If migrilla.Rows.Count <= 0 Then
            Form_guias_traslado.txt_rut_cliente.Focus()
            Me.Close()
        Else
            codigo = migrilla.CurrentRow.Cells(0).Value
            Form_guias_traslado.limpiar_datos_clientes()
            Form_guias_traslado.txt_rut_cliente.Text = codigo
            mostrar_datos_clientes()
            Form_guias_traslado.limpiar_datos_clientes_retira()
            Form_guias_traslado.calcular_totales()
            Me.Close()
        End If
    End Sub
    ...
    Sub mostrar_datos_clientes()
        ...
        If DS.Tables(DT.TableName).Rows.Count = 1 Then
            ...
            Form_guias_traslado.txt_rut_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("rut_cliente")
            Form_guias_traslado.txt_nombre_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("nombre_cliente")
            Form_guias_traslado.txt_direccion_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("direccion_cliente")
            Form_guias_traslado.txt_cod_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("cod_cliente")
            Form_guias_traslado.txt_descuento_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("descuento_1")
            Form_guias_traslado.txt_descuento_cliente_2.Text = DS.Tables(DT.TableName).Rows(0).Item("descuento_2")
            Form_guias_traslado.txt_giro_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("giro_cliente")
            Form_guias_traslado.txt_comuna_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("comuna_cliente")
            Form_guias_traslado.txt_telefono.Text = DS.Tables(DT.TableName).Rows(0).Item("telefono_cliente")
            Form_guias_traslado.txt_cuenta_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("estado_cuenta")
            Form_guias_traslado.txt_folio.Text = DS.Tables(DT.TableName).Rows(0).Item("folio_cliente")
            Form_guias_traslado.txt_correo_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("email_cliente")
            Form_guias_traslado.txt_ciudad_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("ciudad_cliente")
            'Form_guias_traslado.txt_porcentaje_desc.Text = DS.Tables(DT.TableName).Rows(0).Item("descuento_1")
            Form_guias_traslado.txt_orden_de_compra.Text = DS.Tables(DT.TableName).Rows(0).Item("orden_de_compra")
            Form_guias_traslado.txt_tipo_documento.Text = DS.Tables(DT.TableName).Rows(0).Item("tipo_cuenta")
