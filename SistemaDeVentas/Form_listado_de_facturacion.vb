...
Public Class Form_listado_de_facturacion
    ...
    Sub mostrar_lista()
        ...
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
            For U = 0 To DS.Tables(DT.TableName).Rows.Count - 1
                grilla_lista.Rows.Add(DS.Tables(DT.TableName).Rows(U).Item("NRO."),
                                       DS.Tables(DT.TableName).Rows(U).Item("RUT"),
                                        DS.Tables(DT.TableName).Rows(U).Item("NOMBRE"),
                                         DS.Tables(DT.TableName).Rows(U).Item("GUIAS"),
                                          DS.Tables(DT.TableName).Rows(U).Item("DESCUENTO"),
                                           DS.Tables(DT.TableName).Rows(U).Item("TOTAL"),
                                            DS.Tables(DT.TableName).Rows(U).Item("FOLIO"))
            Next
        End If
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If tipo_impresion = 1 Then
            e.Graphics.DrawString("FACTURA", Font_titulo_columna, Brushes.Black, margen_izquierdo + 10, margen_superior + 140)
            e.Graphics.DrawString("RUT", Font_titulo_columna, Brushes.Black, margen_izquierdo + 110, margen_superior + 140)
            e.Graphics.DrawString("NOMBRE", Font_titulo_columna, Brushes.Black, margen_izquierdo + 210, margen_superior + 140)
            e.Graphics.DrawString("TOTAL GUIAS", Font_titulo_columna, Brushes.Black, margen_izquierdo + 510, margen_superior + 140, format1)
            e.Graphics.DrawString("DESCUENTO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 610, margen_superior + 140, format1)
            e.Graphics.DrawString("TOTAL", Font_titulo_columna, Brushes.Black, margen_izquierdo + 710, margen_superior + 140, format1)
            e.Graphics.DrawString("FOLIO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 810, margen_superior + 140, format1)
            ...
            For i = numero_lineas_total To grilla_lista.Rows.Count - 1
                ...
                e.Graphics.DrawString(VarFactura, Font_texto_impresion, Brushes.Black, margen_izquierdo + 10, margen_superior + 160 + (numero_lineas * multiplicador_lineas))
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarRut, Font_texto_impresion, Brushes.Black, margen_izquierdo + 110, margen_superior + 160 + (numero_lineas * multiplicador_lineas))
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarNombre, Font_texto_impresion, Brushes.Black, margen_izquierdo + 210, margen_superior + 160 + (numero_lineas * multiplicador_lineas))
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarGuias, Font_texto_impresion, Brushes.Black, margen_izquierdo + 510, margen_superior + 160 + (numero_lineas * multiplicador_lineas), format1)
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarDescuento, Font_texto_impresion, Brushes.Black, margen_izquierdo + 610, margen_superior + 160 + (numero_lineas * multiplicador_lineas), format1)
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarTotal, Font_texto_impresion, Brushes.Black, margen_izquierdo + 710, margen_superior + 160 + (numero_lineas * multiplicador_lineas), format1)
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarFolio, Font_texto_impresion, Brushes.Black, margen_izquierdo + 810, margen_superior + 160 + (numero_lineas * multiplicador_lineas), format1)
                '***************************************************************************************************************************************************
        ...
        If tipo_impresion = 2 Then
            e.Graphics.DrawString("FACTURA", Font_titulo_columna, Brushes.Black, margen_izquierdo + 10, margen_superior + 140)
            e.Graphics.DrawString("RUT", Font_titulo_columna, Brushes.Black, margen_izquierdo + 70, margen_superior + 140)
            e.Graphics.DrawString("NOMBRE", Font_titulo_columna, Brushes.Black, margen_izquierdo + 150, margen_superior + 140)
            e.Graphics.DrawString("TOTAL GUIAS", Font_titulo_columna, Brushes.Black, margen_izquierdo + 430, margen_superior + 140, format1)
            e.Graphics.DrawString("DESCUENTO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 510, margen_superior + 140, format1)
            e.Graphics.DrawString("TOTAL", Font_titulo_columna, Brushes.Black, margen_izquierdo + 580, margen_superior + 140, format1)
            e.Graphics.DrawString("FOLIO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 650, margen_superior + 140, format1)
            e.Graphics.DrawString("ENTREGADO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 660, margen_superior + 140)
            ...
            For i = numero_lineas_total To grilla_lista.Rows.Count - 1
                ...
                'e.Graphics.DrawString("NOMBRE", Font_titulo_columna, Brushes.Black, margen_izquierdo + 150, margen_superior + 140)
                'e.Graphics.DrawString("TOTAL GUIAS", Font_titulo_columna, Brushes.Black, margen_izquierdo + 430, margen_superior + 140, format1)
                'e.Graphics.DrawString("DESCUENTO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 500, margen_superior + 140, format1)
                'e.Graphics.DrawString("TOTAL", Font_titulo_columna, Brushes.Black, margen_izquierdo + 580, margen_superior + 140, format1)
                'e.Graphics.DrawString("FOLIO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 650, margen_superior + 140, format1)
                'e.Graphics.DrawString("ENTREGADO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 680, margen_superior + 140)

                e.Graphics.DrawString(VarFactura, Font_texto_impresion, Brushes.Black, margen_izquierdo + 10, margen_superior + 160 + (numero_lineas * multiplicador_lineas))
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarRut, Font_texto_impresion, Brushes.Black, margen_izquierdo + 70, margen_superior + 160 + (numero_lineas * multiplicador_lineas))
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarNombre, Font_texto_impresion, Brushes.Black, margen_izquierdo + 150, margen_superior + 160 + (numero_lineas * multiplicador_lineas))
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarGuias, Font_texto_impresion, Brushes.Black, margen_izquierdo + 430, margen_superior + 160 + (numero_lineas * multiplicador_lineas), format1)
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarDescuento, Font_texto_impresion, Brushes.Black, margen_izquierdo + 500, margen_superior + 160 + (numero_lineas * multiplicador_lineas), format1)
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarTotal, Font_texto_impresion, Brushes.Black, margen_izquierdo + 580, margen_superior + 160 + (numero_lineas * multiplicador_lineas), format1)
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(VarFolio, Font_texto_impresion, Brushes.Black, margen_izquierdo + 650, margen_superior + 160 + (numero_lineas * multiplicador_lineas), format1)
                '***************************************************************************************************************************************************

                e.Graphics.DrawString(".........................................", Font_texto_impresion, Brushes.Black, margen_izquierdo + 660, margen_superior + 160 + (numero_lineas * multiplicador_lineas))
                '***************************************************************************************************************************************************
