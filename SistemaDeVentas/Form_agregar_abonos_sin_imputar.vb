...
Public Class Form_agregar_abonos_sin_imputar
    ...
    Private Sub DocImprimir_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 0, margen_superior + 425, margen_izquierdo + 270, margen_superior + 425)
        ...
        End If
        e.Graphics.DrawString("TOTAL INGRESO: " & total_abono, Font_texto_totales, Brushes.Black, margen_izquierdo + 265, margen_superior + 430, format1)
