...
Public Class Form_buscador_productos_guia_traslado
    ...
    Private Sub Form_buscar_productos_guia_traslado_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_guias_traslado.Enabled = True
        Form_guias_traslado.WindowState = FormWindowState.Normal

        If Form_guias_traslado.txt_nombre_producto.Text = "" And Form_guias_traslado.txt_numero_tecnico.Text = "" And Form_guias_traslado.txt_precio_modificado.Text = "" Then
            Form_guias_traslado.txt_codigo.Focus()
        Else
            Form_guias_traslado.txt_cantidad_agregar.Text = "1"
            Form_guias_traslado.txt_precio_modificado.Focus()
        End If
    End Sub

    Private Sub Form_buscar_productos_guia_traslado_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_productos_guia_traslado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
        txt_busqueda.Focus()
    ...
    Private Sub migrilla_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles grilla_buscador_productos_ventas.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Form_guias_traslado.txt_codigo.Text = codigo
            Form_guias_traslado.limpiar_datos_productos()
            Form_guias_traslado.mostrar_cantidad_real()
            Form_guias_traslado.mostrar_nombre_proveedor()
            Form_guias_traslado.txt_cantidad_agregar.Text = ""
            Form_guias_traslado.txt_cantidad_agregar.Focus()
            Me.Close()
        End If
    End Sub
