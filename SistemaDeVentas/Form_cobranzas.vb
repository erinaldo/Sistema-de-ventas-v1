Public Class Form_cobranzas
    ...
    Sub cargar_detalle()
        Try
            ...
            DS.Clear()
            SC.Connection = conexion
            SC.CommandText = "select * from registro_de_cobranzas, clientes, usuarios where registro_de_cobranzas.usuario_responsable=usuarios.rut_usuario and registro_de_cobranzas.rut_cliente=clientes.rut_cliente and registro_de_cobranzas.rut_cliente='" & (txt_rut_cliente.Text) & "' group by registro_de_cobranzas.cod_auto order by fecha desc"
            DA.SelectCommand = SC
            DA.Fill(DT)
            DS.Tables.Add(DT)
            ...
            If DS.Tables(DT.TableName).Rows.Count > 0 Then
                ...
                For i = 0 To DS.Tables(DT.TableName).Rows.Count - 1
                    ...
                    grilla_cobranzas.Rows.Add(DS.Tables(DT.TableName).Rows(i).Item("nombre_cliente"),
    ...
    Private Sub grilla_cobranzas_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles grilla_cobranzas.Click
        ...
        txt_cod_auto.Text = grilla_cobranzas.CurrentRow.Cells(5).Value.ToString
    End Sub
