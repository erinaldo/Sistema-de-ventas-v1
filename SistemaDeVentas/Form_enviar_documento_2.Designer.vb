...
Partial Class Form_enviar_documento_2
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Form_enviar_documento_2))
        ...
        Me.grilla_detalle.TabIndex = 290
        ...
        Me.PictureBox_logo.TabIndex = 294
        ...
        Me.GroupBox_tipo_precio.TabIndex = 289
        ...
        Me.GroupBox_proveedor.TabIndex = 291
        ...
        Me.GroupBox_electronicas.TabIndex = 297
        ...
        Me.GroupBox_valores.TabIndex = 292
        ...
        Me.txt_rut_proveedor.TabIndex = 288
        Me.txt_rut_proveedor.TabStop = False
        '
        'Form_enviar_documento_2
        '
        ...
        Me.Name = "Form_enviar_documento_2"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Form_enviar_documento_2"
    ...
    Friend WithEvents Desc3 As DataGridViewTextBoxColumn
    ...
    Friend WithEvents Combo_sucursal As ComboBox
    Friend WithEvents lbl_mensaje As Label
    Friend WithEvents GroupBox_tipo As GroupBox
    Friend WithEvents Radio_iva As RadioButton
    Friend WithEvents Radio_neto As RadioButton
    Friend WithEvents PictureBox_logo As PictureBox
    Friend WithEvents GroupBox_tipo_precio As GroupBox
    Friend WithEvents Radio_margen As RadioButton
    Friend WithEvents Radio_precio_venta As RadioButton
    Friend WithEvents GroupBox4 As GroupBox
    Friend WithEvents btn_cargar As Button
    Friend WithEvents btn_grabar As Button
    Friend WithEvents GroupBox_proveedor As GroupBox
    Friend WithEvents txt_nro_doc As TextBox
    Friend WithEvents Label13 As Label
    Friend WithEvents txt_nombre_proveedor As TextBox
    Friend WithEvents Label2 As Label
    Friend WithEvents GroupBox_electronicas As GroupBox
    Friend WithEvents Label29 As Label
    Friend WithEvents radio_codigo_de_barra As RadioButton
    Friend WithEvents radio_solo_numeros As RadioButton
    Friend WithEvents GroupBox2 As GroupBox
    Friend WithEvents Radio_impresora_1 As RadioButton
    Friend WithEvents Radio_impresora_2 As RadioButton
    Friend WithEvents GroupBox_valores As GroupBox
    Friend WithEvents txt_factor As TextBox
    Friend WithEvents Label24 As Label
    Friend WithEvents txt_total_producto As TextBox
    Friend WithEvents Label21 As Label
    Friend WithEvents txt_costo_actual As TextBox
    Friend WithEvents lbl_venta As Label
    Friend WithEvents txt_precio_venta_producto As TextBox
    Friend WithEvents Label8 As Label
    Friend WithEvents txt_rut_proveedor As TextBox
End Class
