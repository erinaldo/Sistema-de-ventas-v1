...
Public Class Form_caja_registradora
    ...
    Sub mostrar_malla()
        ...
        If combo_venta.Text = "BOLETA" Then
            If Check_estado.Checked = True Then
                consulta_sql = "select documento as 'TIPO', nro_documento as 'NRO.', condiciones as 'CONDIC.', fecha_venta as 'FECHA', listado_documentos.rut_cliente as 'RUT CLIENTE', nombre_cliente as 'CLIENTE', subtotal as 'SUBTOTAL', porcentaje_desc '%', descuento as 'DESC.', neto as 'NETO', iva as 'IVA', total as 'TOTAL', nombre_usuario as 'VENDEDOR',  vuelto as 'VUELTO', estado_vuelto as 'ESTADO' from listado_documentos, usuarios, clientes  where documento='BOLETA' and estado_vuelto = 'NO'  and fecha_venta ='" & (Form_menu_principal.dtp_fecha.Text) & "' and listado_documentos.usuario_responsable=usuarios.rut_usuario and listado_documentos.rut_cliente=clientes.rut_cliente and condiciones <> 'CREDITO' group by nro_documento order by nro_documento desc"
            Else
                consulta_sql = "select documento as 'TIPO', nro_documento as 'NRO.', condiciones as 'CONDIC.', fecha_venta as 'FECHA', listado_documentos.rut_cliente as 'RUT CLIENTE', nombre_cliente as 'CLIENTE', subtotal as 'SUBTOTAL', porcentaje_desc '%', descuento as 'DESC.', neto as 'NETO', iva as 'IVA', total as 'TOTAL', nombre_usuario as 'VENDEDOR',  vuelto as 'VUELTO', estado_vuelto as 'ESTADO' from listado_documentos, usuarios, clientes  where documento='BOLETA' and fecha_venta >='" & (Form_menu_principal.dtp_fecha.Text) & "' and listado_documentos.usuario_responsable=usuarios.rut_usuario and listado_documentos.rut_cliente=clientes.rut_cliente and condiciones <> 'CREDITO' group by nro_documento order by nro_documento desc"
            End If
        End If

        If combo_venta.Text = "FACTURA" Then
            If Check_estado.Checked = True Then
                consulta_sql = "select documento as 'TIPO', nro_documento as 'NRO.', condiciones as 'CONDIC.', fecha_venta as 'FECHA', listado_documentos.rut_cliente as 'RUT CLIENTE', nombre_cliente as 'CLIENTE', subtotal as 'SUBTOTAL', porcentaje_desc '%', descuento as 'DESC.', neto as 'NETO', iva as 'IVA', total as 'TOTAL', nombre_usuario as 'VENDEDOR', vuelto as 'VUELTO', estado_vuelto as 'ESTADO'  from listado_documentos, usuarios, clientes  where documento='FACTURA' and estado_vuelto = 'NO' and fecha_venta ='" & (Form_menu_principal.dtp_fecha.Text) & "' and listado_documentos.usuario_responsable=usuarios.rut_usuario and listado_documentos.rut_cliente=clientes.rut_cliente  and condiciones <> 'CREDITO' group by nro_documento order by nro_documento desc"
            Else
                consulta_sql = "select documento as 'TIPO', nro_documento as 'NRO.', condiciones as 'CONDIC.', fecha_venta as 'FECHA', listado_documentos.rut_cliente as 'RUT CLIENTE', nombre_cliente as 'CLIENTE', subtotal as 'SUBTOTAL', porcentaje_desc '%', descuento as 'DESC.', neto as 'NETO', iva as 'IVA', total as 'TOTAL', nombre_usuario as 'VENDEDOR', vuelto as 'VUELTO', estado_vuelto as 'ESTADO'  from listado_documentos, usuarios, clientes  where documento='FACTURA' and fecha_venta >='" & (Form_menu_principal.dtp_fecha.Text) & "' and listado_documentos.usuario_responsable=usuarios.rut_usuario and listado_documentos.rut_cliente=clientes.rut_cliente  and condiciones <> 'CREDITO' group by nro_documento order by nro_documento desc"
            End If
        End If

        If combo_venta.Text = "TODOS" Then
            If Check_estado.Checked = True Then
                consulta_sql = "select documento as 'TIPO', nro_documento as 'NRO.', condiciones as 'CONDIC.', fecha_venta as 'FECHA', listado_documentos.rut_cliente as 'RUT CLIENTE', nombre_cliente as 'CLIENTE', subtotal as 'SUBTOTAL', porcentaje_desc '%', descuento as 'DESC.', neto as 'NETO', iva as 'IVA', total as 'TOTAL', nombre_usuario as 'VENDEDOR',  vuelto as 'VUELTO', estado_vuelto as 'ESTADO' from listado_documentos, usuarios, clientes  where estado_vuelto = 'NO'  and fecha_venta ='" & (Form_menu_principal.dtp_fecha.Text) & "' and listado_documentos.usuario_responsable=usuarios.rut_usuario and listado_documentos.rut_cliente=clientes.rut_cliente and condiciones <> 'CREDITO' "
                consulta_sql = consulta_sql & " and documento <> 'GUIA'"
                consulta_sql = consulta_sql & " group by nro_documento order by nro_documento desc"
            Else
                consulta_sql = "select documento as 'TIPO', nro_documento as 'NRO.', condiciones as 'CONDIC.', fecha_venta as 'FECHA', listado_documentos.rut_cliente as 'RUT CLIENTE', nombre_cliente as 'CLIENTE', subtotal as 'SUBTOTAL', porcentaje_desc '%', descuento as 'DESC.', neto as 'NETO', iva as 'IVA', total as 'TOTAL', nombre_usuario as 'VENDEDOR',  vuelto as 'VUELTO', estado_vuelto as 'ESTADO' from listado_documentos, usuarios, clientes  where fecha_venta ='" & (Form_menu_principal.dtp_fecha.Text) & "' and listado_documentos.usuario_responsable=usuarios.rut_usuario and listado_documentos.rut_cliente=clientes.rut_cliente and condiciones <> 'CREDITO' "
                consulta_sql = consulta_sql & " and documento <> 'GUIA'"
                consulta_sql = consulta_sql & " group by nro_documento order by nro_documento desc"
            End If
        End If
        ...
        'DS = New DataSet()
        'DA.Fill(DS)
        'grilla_estado_de_cuenta.DataSource = DS.Tables(0).DefaultView
        ...
        If DS2.Tables(DT2.TableName).Rows.Count > 0 Then
            For i = 0 To DS2.Tables(DT2.TableName).Rows.Count - 1
                ...
                grilla_estado_de_cuenta.Rows.Add(DS2.Tables(DT2.TableName).Rows(i).Item("TIPO"),
    ...
    Sub mostrar_malla_detalle()
        ...
        tipo_doc = grilla_estado_de_cuenta.CurrentRow.Cells(0).Value
        nro_doc = grilla_estado_de_cuenta.CurrentRow.Cells(1).Value

        If tipo_doc.Contains("BOLETA") Then
        ...
        If tipo_doc.Contains("FACTURA") Then
    ...
    Private Sub btn_abrir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_abrir.Click
        ...
        tipo_documento = grilla_estado_de_cuenta.CurrentRow.Cells(0).Value
        ...
        Try
            If tipo_documento.Contains("FACTURA") Then
                SC.Connection = conexion
            ...
            SC.Connection = conexion
            SC.CommandText = "UPDATE listado_documentos SET vuelto='" & (vuelto) & "', estado_vuelto='SI' WHERE documento='" & (tipo_documento) & "' and nro_documento='" & (grilla_estado_de_cuenta.CurrentRow.Cells(1).Value) & "'"
            DA.SelectCommand = SC
            DA.Fill(DT)
    ...
    Private Sub grilla_estado_de_cuenta_KeyDown(sender As Object, e As KeyEventArgs) Handles grilla_estado_de_cuenta.KeyDown
