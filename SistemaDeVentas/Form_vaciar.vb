...
Public Class Form_vaciar
    ...
    Sub vaciar()
        ...
        conexion.ConnectionString = "Database=bd_huskly; Data Source=localhost; User Id=root;Password=1234;Convert Zero Datetime=True"
        ...
        DA.Fill(DT)
        SC.Connection = conexion
        SC.CommandText = "INSERT INTO clientes_retira (rut_cliente_retira, nombre_cliente_retira) VALUES  ('-','-')"
        DA.SelectCommand = SC
        DA.Fill(DT)
    ...
    Private Sub Form_vaciar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        conexion.Close()
        conexion.ConnectionString = "Database=basededatos; Data Source=localhost; User Id=root;Password=1234;Convert Zero Datetime=True"
    ...
    Sub cargar_tablas()
        ...
        DS.Clear()
        SC.Connection = conexion
        SC.CommandText = "select table_name, column_name From information_schema.key_column_usage WHERE TABLE_SCHEMA='bd_cd_santacruz';"
        DA.SelectCommand = SC
        DA.Fill(DT)
        DS.Tables.Add(DT)
