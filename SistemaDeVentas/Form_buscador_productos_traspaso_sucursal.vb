...
Public Class Form_buscador_productos_traspaso_sucursal
    ...
    Private Sub Form_buscador_productos_traspaso_sucursal_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
    ...
    Private Sub Form_buscador_productos_traspaso_sucursal_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
    ...
    Private Sub Form_buscador_productos_traspaso_sucursal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub grilla_buscador_productos_ventas_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles grilla_buscador_productos_ventas.DoubleClick
        ...
        Form_envio_productos_sucursal.txt_codigo.Text = codigo
        Form_envio_productos_sucursal.limpiar_producto()
        Form_envio_productos_sucursal.mostrar_datos_productos()
        Form_envio_productos_sucursal.txt_cantidad.Text = ""
        Form_envio_productos_sucursal.txt_cantidad.Focus()
        Me.Close()
        ' End If
    End Sub
