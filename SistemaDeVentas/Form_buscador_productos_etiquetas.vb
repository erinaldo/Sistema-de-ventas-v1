...
Public Class Form_buscador_productos_etiquetas
    ...
    Private Sub Form_buscar_productos_etiquetas_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_crear_etiquetas.Enabled = True
        Form_crear_etiquetas.WindowState = FormWindowState.Normal
        Form_crear_etiquetas.txt_codigo.Focus()
    End Sub

    Private Sub Form_buscar_productos_etiquetas_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_productos_etiquetas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
        txt_busqueda.Focus()
    End Sub
    ...
    Private Sub migrilla_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles grilla_buscador_productos.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Form_crear_etiquetas.limpiar_producto()
            Form_crear_etiquetas.txt_codigo.Text = codigo
            Form_crear_etiquetas.mostrar_datos_productos()
            Form_crear_etiquetas.txt_codigo.Focus()
            Me.Close()
        End If
    End Sub
