...
Public Class Form_conteos_arana
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Dim rect_titulo As New Rectangle(margen_izquierdo + 10, margen_superior + 85, margen_izquierdo + 780, margen_superior + 45)
        Dim rect_fecha As New Rectangle(margen_izquierdo + 10, margen_superior + 100, margen_izquierdo + 780, margen_superior + 60)
        ...
        e.Graphics.DrawString("FAMILIA", Font_titulo_columna, Brushes.Black, margen_izquierdo + 10, margen_superior + 150)
        e.Graphics.DrawString("PRODUCTO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 100, margen_superior + 150)
        e.Graphics.DrawString("DESCRIPCION", Font_titulo_columna, Brushes.Black, margen_izquierdo + 180, margen_superior + 150)
        e.Graphics.DrawString("NRO. TECNICO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 340, margen_superior + 150)
        e.Graphics.DrawString("CANTIDAD", Font_titulo_columna, Brushes.Black, margen_izquierdo + 540, margen_superior + 150, format1)
        e.Graphics.DrawString("FISICO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 560, margen_superior + 150)
        e.Graphics.DrawString("OBSERVACIONES", Font_titulo_columna, Brushes.Black, margen_izquierdo + 650, margen_superior + 150)
        ...
        For i = numero_lineas_total To grilla_conteos.Rows.Count - 1
            ...
            e.Graphics.DrawString(VarFamilia, Font_texto_impresion, Brushes.Black, margen_izquierdo + 10, margen_superior + 170 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarProducto, Font_texto_impresion, Brushes.Black, margen_izquierdo + 100, margen_superior + 170 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarDescripcion, Font_texto_impresion, Brushes.Black, margen_izquierdo + 180, margen_superior + 170 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarNumeroTecnico, Font_texto_impresion, Brushes.Black, margen_izquierdo + 340, margen_superior + 170 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarCantidad, Font_texto_impresion, Brushes.Black, margen_izquierdo + 540, margen_superior + 170 + (numero_lineas * multiplicador_lineas), format1)
            '***************************************************************************************************************************************************
