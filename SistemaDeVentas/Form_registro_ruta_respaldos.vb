...
Public Class Form_registro_ruta_respaldos
    Dim VarSeleccion As Integer
    Dim MiPos As Integer
    Private Sub Form_registro_ruta_respaldos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_menu_principal.WindowState = FormWindowState.Normal
    End Sub

    Private Sub Form_registro_ruta_respaldos_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_registro_ruta_respaldos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        actualizar_tabla()
        mostrar(0)
    ...
    Sub mostrar(ByVal i As Integer)
        Try
            If DS.Tables(DT.TableName).Rows.Count > 0 Then
                txt_ruta_archivo_respaldo.Text = DS.Tables(DT.TableName).Rows(i).Item("archivo_respaldo")
                txt_ruta_programa_respaldo.Text = DS.Tables(DT.TableName).Rows(i).Item("ruta_nube")
            End If
        Catch
        End Try
    End Sub
    ...
    Sub controles(ByVal a As Boolean, ByVal b As Boolean)
        ...
        txt_ruta_archivo_respaldo.Enabled = a
        txt_ruta_programa_respaldo.Enabled = a

    End Sub

    Sub limpiar()
        txt_ruta_archivo_respaldo.Text = ""
        txt_ruta_programa_respaldo.Text = ""
    End Sub
    ...
    Private Sub btn_nuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_nuevo.Click
        ...
        VarSeleccion = 1
        txt_ruta_archivo_respaldo.Focus()
    End Sub

    Private Sub btn_guardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        If txt_ruta_archivo_respaldo.Text = "" Then
            MsgBox("CAMPO RUTA RESPALDO VACIO, FAVOR LLENAR", MessageBoxIcon.Information, "ATENCION")
            txt_ruta_archivo_respaldo.Focus()
            Exit Sub
        End If

        If txt_ruta_programa_respaldo.Text = "" Then
            MsgBox("CAMPO RUTA PROGRAMA RESPALDO VACIO, FAVOR LLENAR", MessageBoxIcon.Information, "ATENCION")
            txt_ruta_programa_respaldo.Focus()
            Exit Sub
        End If

        txt_ruta_archivo_respaldo.Text = Trim(Replace(txt_ruta_archivo_respaldo.Text, "\", "\\"))
        txt_ruta_programa_respaldo.Text = Trim(Replace(txt_ruta_programa_respaldo.Text, "\", "\\"))
        ...
        SC.Connection = conexion
        SC.CommandText = "UPDATE rutas_archivos SET archivo_respaldo='" & (txt_ruta_archivo_respaldo.Text) & "', ruta_nube='" & (txt_ruta_programa_respaldo.Text) & "' where cod_auto <> '0'"
        DA.SelectCommand = SC
        DA.Fill(DT)
    ...
    Private Sub txt_ruta_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_ruta_archivo_respaldo.GotFocus
        txt_ruta_archivo_respaldo.BackColor = Color.LightSkyBlue
    End Sub


    Private Sub txt_ruta_HelpRequested(ByVal sender As Object, ByVal hlpevent As System.Windows.Forms.HelpEventArgs) Handles txt_ruta_archivo_respaldo.HelpRequested

    End Sub

    Private Sub txt_nombre_familia_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_ruta_archivo_respaldo.KeyPress
        e.KeyChar = e.KeyChar.ToString.ToUpper
    ...
    Private Sub txt_ruta_lostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_ruta_archivo_respaldo.LostFocus
        txt_ruta_archivo_respaldo.BackColor = Color.White
    End Sub
    ...
    Private Sub btnExaminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExaminar.Click
        ...
        If result = DialogResult.OK Then
            txt_ruta_archivo_respaldo.Text = OpenFileDialog1.FileName
        End If
    ...
    Private Sub txt_ruta_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_ruta_archivo_respaldo.TextChanged

    End Sub

    Private Sub txt_ruta_facturacion_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_ruta_programa_respaldo.GotFocus
        txt_ruta_programa_respaldo.BackColor = Color.LightSkyBlue
    End Sub

    Private Sub txt_ruta_facturacion_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_ruta_programa_respaldo.KeyPress
        e.KeyChar = e.KeyChar.ToString.ToUpper
    ...
    Private Sub txt_ruta_facturacion_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_ruta_programa_respaldo.LostFocus
        txt_ruta_programa_respaldo.BackColor = Color.White
    End Sub

    Private Sub txt_ruta_facturacion_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_ruta_programa_respaldo.TextChanged
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_examinar_facturacion.Click
        ...
        If result = DialogResult.OK Then
            txt_ruta_programa_respaldo.Text = OpenFileDialog2.FileName
        End If
    End Sub
End Class