...
Public Class Form_registro_clientes_ventas
    ...
    Private Sub Form_registro_clientes_ventas_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
