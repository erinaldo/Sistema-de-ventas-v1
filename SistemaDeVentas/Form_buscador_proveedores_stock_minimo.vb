...
Public Class Form_buscador_proveedores_stock_minimo
    Dim consulta_busqueda As String
    Private Sub Form_buscar_proveedores_stock_minimo_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_stock.WindowState = FormWindowState.Normal
        Form_stock.Enabled = True
    End Sub

    Private Sub Form_buscar_proveedores_stock_minimo_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_proveedores_stock_minimo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        ...
        If migrilla.Rows.Count <= 0 Then
            Form_stock.txt_rut_proveedor.Focus()
            Me.Close()
        Else
            codigo = migrilla.CurrentRow.Cells(0).Value
            Form_stock.txt_rut_proveedor.Text = codigo
            Form_stock.mostrar_datos_proveedores()
            Form_stock.grilla_stock.DataSource = Nothing
            Form_stock.grilla_stock_final.Rows.Clear()
            Form_stock.mostrar_malla()
