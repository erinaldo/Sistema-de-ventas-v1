...
Public Class Form_buscador_clientes_abonos
    ...
    Private Sub form_buscar_clientes_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        If Form_agregar_abonos_manuales.Visible = True Then
            Form_agregar_abonos_manuales.WindowState = FormWindowState.Normal
            Form_agregar_abonos_manuales.Enabled = True
            Form_agregar_abonos_manuales.txt_rut.Focus()
            Exit Sub
        End If
    End Sub
    ...
    Private Sub migrilla_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles migrilla.KeyDown
        ...
        If Form_agregar_abonos_manuales.Visible = True Then
            If e.KeyCode = Keys.Enter Then
                ...
                Else
                    codigo = migrilla.CurrentRow.Cells(0).Value
                    Form_agregar_abonos_manuales.limpiar_datos_cliente()
                    Form_agregar_abonos_manuales.txt_rut.Text = codigo
                    Form_agregar_abonos_manuales.Combo_cuotas.Items.Clear()
                    Form_agregar_abonos_manuales.grilla_estado_de_cuenta.Rows.Clear()
                    Form_agregar_abonos_manuales.calcular_totales()
                    Form_agregar_abonos_manuales.txt_rut.Focus()
                    Me.Close()
                End If
            End If
