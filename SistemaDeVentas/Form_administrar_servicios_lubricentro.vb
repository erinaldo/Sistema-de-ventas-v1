...
Public Class Form_administrar_servicios_lubricentro
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Dim rect2 As New Rectangle(margen_izquierdo + 10, margen_superior + 90, margen_izquierdo + 780, margen_superior + 75)
        ...
        e.Graphics.DrawString("POR MEDIO DE LA PRESENTE, LA EMPRESA ARANA Y CIA LIMITADA CERTIFICA QUE EL DÍA " & VarFecha & " SE", Font_campos_superiores, Brushes.Black, margen_izquierdo + 10, margen_superior + 145)
        e.Graphics.DrawString("RECIBIÓ EL VEHÍCULO " & VarVehiculo & ", PATENTE " & VarPatente & ", CON " & VarKilometros & " KMS., Y SE LE INSTALARON LOS", Font_campos_superiores, Brushes.Black, margen_izquierdo + 10, margen_superior + 160)
        e.Graphics.DrawString("SIGUIENTES ITEMS:", Font_campos_superiores, Brushes.Black, margen_izquierdo + 10, margen_superior + 175)

        e.Graphics.DrawString("CANTIDAD", Font_titulo_columna, Brushes.Black, margen_izquierdo + 100, margen_superior + 215, format1)
        e.Graphics.DrawString("CODIGO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 160, margen_superior + 215)
        e.Graphics.DrawString("DESCRIPCION", Font_titulo_columna, Brushes.Black, margen_izquierdo + 260, margen_superior + 215)
        e.Graphics.DrawString("NRO. TECNICO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 560, margen_superior + 215)
        ...
        For i = numero_lineas_total To grilla_detalle_productos.Rows.Count - 1
            ...
            e.Graphics.DrawString(VarCantidad, Font_texto_impresion, Brushes.Black, margen_izquierdo + 100, margen_superior + 245 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarCodigo, Font_texto_impresion, Brushes.Black, margen_izquierdo + 160, margen_superior + 245 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarNombre, Font_texto_impresion, Brushes.Black, margen_izquierdo + 260, margen_superior + 245 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarNumeroTecnico, Font_texto_impresion, Brushes.Black, margen_izquierdo + 560, margen_superior + 245 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************
            ...
            If numero_lineas > 85 Then
                'Linea horizontal
                e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 10, margen_superior + 255 + (numero_lineas * multiplicador_lineas), margen_izquierdo + 810, margen_superior + 255 + (numero_lineas * multiplicador_lineas))
                '***************************************************************************************************************************************************
