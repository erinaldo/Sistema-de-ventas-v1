...
Public Class Form_buscador_productos_compras
    ...
    Private Sub form_buscar_productos_compras_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        Form_Compra.Enabled = True
        Form_Compra.WindowState = FormWindowState.Normal

        ' If Form_venta.txt_nombre_producto.Text = "" And Form_venta.txt_numero_tecnico.Text = "" And Form_venta.txt_precio.Text = "" Then
    ...
    Private Sub form_buscar_productos_compras_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
        txt_busqueda.Focus()
        Timer_inactividad_buscar_productos_compras.Start()
    End Sub
    ...
    Sub buscar()
        ...
        If txt_busqueda.Text <> "" Then
            ...
            For n = 0 To UBound(tabla, 1)
                consulta_busqueda = consulta_busqueda & "AND CONCAT_WS(' ',COD_PRODUCTO, NOMBRE, APLICACION, NUMERO_TECNICO, marca,  nombre_proveedor, rut_proveedor) LIKE '" & ("%" & tabla(n) & "%") & "'"
            Next
    ...
    Private Sub grilla_bucador_productos_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grilla_buscador_productos.CellContentClick

    End Sub

    Private Sub Timer_inactividad_buscar_productos_compras_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer_inactividad_buscar_productos_compras.Tick
