...
Public Class Form_registro_productos_compra
    ...
    Private Sub form_registro_productos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        If Form_Compra.txt_nombre_producto.Text <> "" And Form_Compra.txt_aplicacion.Text <> "" And Form_Compra.txt_numero_tecnico_producto.Text <> "" Then
    ...
    Private Sub Form_registro_productos_compra_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Form_Compra.WindowState = FormWindowState.Normal
    End Sub

    Private Sub Form_registro_productos_compra_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub btn_guardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        ...
        If VarSeleccionproducto = 1 Then
            ...
            SC.Connection = conexion
            SC.CommandText = "INSERT INTO productos(cod_producto, nombre, marca, aplicacion, numero_tecnico, cantidad, precio, costo, familia, subfamilia, subfamilia_dos, proveedor, codigo_barra,   ultima_compra, cantidad_ultima_compra, nro_doc, tipo_doc, cantidad_minima, fecha_modificacion, margen, numero_proveedor, tipo_precio, estado_producto, activo) VALUES ('" & (txt_codigo.Text) & "','" & (txt_nombre.Text) & "','" & (txt_marca.Text) & "','" & (txt_aplicacion.Text) & "','" & (txt_numero_tecnico.Text) & "','" & (txt_cantidad.Text) & "','" & (txt_precio.Text) & "','" & (txt_costo.Text) & "','" & (txt_codigo_familia.Text) & "','" & (txt_codigo_subfamilia.Text) & "','" & (txt_codigo_subfamilia_2.Text) & "','" & (txt_rut_proveedor.Text) & "','" & (txt_codigo_barra.Text) & "', '" & (mifecha2) & "','" & (txt_cantidad_ultima_compra.Text) & "', '" & (txt_nro_doc.Text) & "', '" & (txt_tipo_doc.Text) & "', '" & (txt_cantidad_minima.Text) & "', '" & (Form_menu_principal.dtp_fecha.Text) & "', '0', '-', '0', '-', '" & (Combo_activo.Text) & "')"
            DA.SelectCommand = SC
            DA.Fill(DT)
            ...
            Form_Compra.txt_codigo_producto.Text = txt_codigo.Text
        ...
        If VarSeleccionproducto = 2 Then
            ...
            If ModificacionActivo <> Combo_activo.Text Then
                SC.Connection = conexion
                SC.CommandText = "insert into bitacora_de_cambios (procedencia, detalle, codigo, fecha, TIPO, usuario_responsable) values('PRODUCTOS','MODIFICACION DE PRODUCTOS', '" & ("SE MODIFICO EL ESTADO " & txt_codigo.Text) & "','" & (Form_menu_principal.dtp_fecha.Text) & "','MODIFICACION','" & (miusuario) & "')"
                DA.SelectCommand = SC
                DA.Fill(DT)
            End If
