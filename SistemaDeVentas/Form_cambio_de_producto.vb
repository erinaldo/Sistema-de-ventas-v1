...
Public Class Form_cambio_de_producto
    ...
    Dim impresora_ticket_vales_de_cambio As String
    ...
    Private Sub Form_cambio_de_producto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dtp_fecha.Value = Form_menu_principal.dtp_fecha.Text
        ...
        mostrar_impresora()
        Form_seleccionar_documento_para_cambio_producto.Show()
    ...
    Sub mostrar_impresora()
        ...
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
            ...
            impresora_ticket_vales_de_cambio = DS.Tables(DT.TableName).Rows(0).Item("ticket_vales_de_cambio")
        End If
        conexion.Close()
    End Sub
    ...
    Private Sub DocImprimir_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        If documento_tipo = "1" Then
            ...
            e.Graphics.DrawString("TOTAL", Font4, Brushes.Black, 285, 325, format1)
            ...
            For i = 0 To grilla_detalle_venta_entra.Rows.Count - 1
                ...
                If descripcion.Length > 17 Then
                    descripcion = descripcion.Substring(0, 17)
                End If

                If vartecnico.Length > 17 Then
                    vartecnico = vartecnico.Substring(0, 17)
                End If
                ...
                If tipo_documento = "VALE DE CAMBIO" Then
                    ...
                    If Int(lbl_venta.Text) <> 0 Then
                        ...
                        With PrintDocument1.PrinterSettings
                            .PrinterName = impresora_ticket_vales_de_cambio
                            .Copies = 1
                            .PrintRange = PrintRange.AllPages
                            If .IsValid Then
                                'Me.Pd.PrintController = New StandardPrintController
    ...
    Sub revisar_traspaso()
        ...
        conexion.Open()
        SC.Connection = conexion
        SC.CommandText = "select * from `vale_cambio`, `detalle_vale_cambio` WHERE documento_referencia='" & (Form_seleccionar_documento_para_cambio_producto.combo_documento.Text) & "' and nro_referencia='" & (Form_seleccionar_documento_para_cambio_producto.txt_nro_documento.Text) & "' and vale_cambio.nro_vale=detalle_vale_cambio.nro_vale and MOVIMIENTO='ENTRA';"
        DA.SelectCommand = SC
        DA.Fill(DT)
        DS.Tables.Add(DT)
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Dim total_saldo As String = lbl_venta.Text

        If total_saldo = "" Or total_saldo = "0" Then
            total_saldo = "0"
        Else
            total_saldo = Format(Int(total_saldo), "###,###,###")
        End If
        ...
        e.Graphics.DrawString(total_saldo, Font_texto_cabecera, Brushes.Black, margen_izquierdo + 85, margen_superior + 305)
        ...
        Dim rect_desglose_saldo As New Rectangle(margen_izquierdo + 85, margen_superior + 320, margen_izquierdo + 190, margen_superior + 30)
        ...
        Dim rect_validez As New Rectangle(margen_izquierdo + 0, margen_superior + 365, margen_izquierdo + 290, margen_superior + 60)
