...
Public Class Form_otro_medio_de_pago_cambio_de_producto

    Private Sub Form_otro_medio_de_pago_cambio_de_producto_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        If txt_medio_pago.Text = "" Then
            Form_cambio_de_producto_condiciones.combo_condiciones.SelectedItem = "-"
        End If
        Form_cambio_de_producto_condiciones.WindowState = FormWindowState.Normal
        Form_cambio_de_producto_condiciones.Enabled = True
    End Sub

    Private Sub Form_otro_medio_de_pago_cambio_de_producto_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp

    End Sub

    Private Sub Form_otro_medio_de_pago_cambio_de_producto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    End Sub
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        ...
        Form_cambio_de_producto_condiciones.combo_condiciones.Items.Add(txt_medio_pago.Text)
        Form_cambio_de_producto_condiciones.combo_condiciones.SelectedItem = txt_medio_pago.Text
        Me.Close()
    End Sub
