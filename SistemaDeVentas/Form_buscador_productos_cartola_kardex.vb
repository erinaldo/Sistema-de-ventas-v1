...
Public Class Form_buscador_productos_cartola_kardex
    ...
    Private Sub Form_buscar_productos_cartola_kardex_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        If Form_cartola_kardex.Visible = True Then
            Form_cartola_kardex.Enabled = True
            Form_cartola_kardex.WindowState = FormWindowState.Normal
            Form_cartola_kardex.txt_codigo_producto.Focus()
        End If

        If Form_cartola_kardex_2.Visible = True Then
            Form_cartola_kardex_2.Enabled = True
            Form_cartola_kardex_2.WindowState = FormWindowState.Normal
            Form_cartola_kardex_2.txt_codigo_producto.Focus()
        End If
    End Sub

    Private Sub Form_buscar_productos_cartola_kardex_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
        txt_busqueda.Focus()
        Timer_inactividad_buscar_productos_kardex.Start()
    End Sub
    ...
    Private Sub migrilla_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles grilla_buscador_productos.KeyDown
        If Form_cartola_kardex.Visible = True Then
            If e.KeyCode = Keys.Enter Then
                ...
                Form_cartola_kardex.limpiar()
                Form_cartola_kardex.txt_codigo_producto.Text = codigo
                Form_cartola_kardex.mostrar_datos_productos()
                Form_cartola_kardex.mostrar_malla()
                Form_cartola_kardex.txt_cantidad_item.Text = Form_cartola_kardex.grilla_kardex.Rows.Count
                Form_cartola_kardex.grilla_kardex.Focus()
                Me.Close()
            End If
        End If
        ...
        If Form_cartola_kardex_2.Visible = True Then
            If e.KeyCode = Keys.Enter Then
                ...
                valor = codigo
                codigo = String.Format("{0:000000}", valor)
                Form_cartola_kardex_2.limpiar()
                Form_cartola_kardex_2.txt_codigo_producto.Text = codigo
                Form_cartola_kardex_2.mostrar_datos_productos()
                Form_cartola_kardex_2.mostrar_malla()
                Form_cartola_kardex_2.txt_cantidad_item.Text = Form_cartola_kardex_2.grilla_kardex.Rows.Count
                Form_cartola_kardex_2.grilla_kardex.Focus()
                Me.Close()
            End If
        End If
    End Sub
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles grilla_buscador_productos.DoubleClick
        If grilla_buscador_productos.Rows.Count <> 0 Then
            ...
            Me.Enabled = False
            Try
                Form_stock_sucursales_cardex.Show()
            Catch
    ...
    Private Sub Timer_inactividad_buscar_productos_kardex_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer_inactividad_buscar_productos_kardex.Tick
    ...
    Private Sub txt_codigo_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs)
