...
Public Class Form_buscador_clientes_documentos
    ...
    Private Sub Form_buscar_clientes_documentos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_documentos.Enabled = True
        Form_documentos.WindowState = FormWindowState.Normal
        Form_documentos.txt_rut.Focus()
    End Sub

    Private Sub Form_buscar_clientes_documentos_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_clientes_documentos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        ...
        Else
            ...
            Form_documentos.limpiar_datos_clientes()
            Form_documentos.txt_rut.Text = codigo
    ...
    Sub mostrar_datos_clientes()
        ...
        If DS.Tables(DT.TableName).Rows.Count = 1 Then
            ...
            Form_documentos.txt_rut.Text = DS.Tables(DT.TableName).Rows(0).Item("rut_cliente")
            Form_documentos.txt_nombre_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("nombre_cliente")
            Form_documentos.txt_telefono.Text = DS.Tables(DT.TableName).Rows(0).Item("telefono_cliente")
            Form_documentos.txt_direccion.Text = DS.Tables(DT.TableName).Rows(0).Item("direccion_cliente")
            Form_documentos.txt_comuna.Text = DS.Tables(DT.TableName).Rows(0).Item("comuna_cliente")
