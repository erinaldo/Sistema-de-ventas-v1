Public Class Form_permisos_2
    ...
    Sub revisar_permisos()
        ...
        For U = 0 To grilla_resumen.Rows.Count - 1

            rut_usuario = grilla_resumen.Rows(U).Cells(1).Value.ToString
            ...
            For i = 2 To grilla_resumen.Columns.Count - 1
                Try
                    ...
                    If DS3.Tables(DT3.TableName).Rows.Count > 0 Then
                        grilla_resumen.Rows(U).Cells(i).Value = True
                        grilla_resumen.Rows(U).Cells(i).Style.BackColor = Color.SkyBlue
                    Else
                        ...
                        'Else
                        grilla_resumen.Rows(U).Cells(i).Value = False
                        grilla_resumen.Rows(U).Cells(i).Style.BackColor = Color.White
                        'End If
                    End If
    ...
    Sub grabar_permisos()
        ...
        For U = 0 To grilla_resumen.Rows.Count - 1
            ...
            For i = 2 To grilla_resumen.Columns.Count - 1
                ...
                If grilla_resumen.Rows(U).Cells(i).Value = True Then
