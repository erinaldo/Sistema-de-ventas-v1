...
Public Class Form_buscador_clientes_recepcion
    Dim mitexto As String
    Dim micampo As String

    Dim consulta_busqueda As String
    Private Sub Form_buscador_clientes_recepcion_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub Form_buscador_clientes_recepcion_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscador_clientes_recepcion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    End Sub
    Sub cargar_logo()
        Try
    ...
    Private Sub migrilla_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles migrilla.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Else
                codigo = migrilla.CurrentRow.Cells(0).Value
                Form_recepcion_de_trabajo.limpiar_datos_clientes()
                Form_recepcion_de_trabajo.txt_rut_cliente.Text = codigo
