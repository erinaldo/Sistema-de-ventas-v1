...
Public Class Form_buscador_clientes_retira
    Dim campo_nombre As String
    Dim campo_apellido As String
    Dim consulta_busqueda As String

    Private Sub Form_buscador_clientes_retira_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_venta.Enabled = True
        Form_venta.txt_rut_retira.Focus()
    End Sub

    Private Sub Form_buscador_clientes_retira_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
        ...
        End If
    End Sub
    Private Sub Form_buscador_clientes_retira_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
        migrilla.Font = New System.Drawing.Font("Arial", 10.25!, System.Drawing.FontStyle.Regular)


        '  migrilla.BackgroundColor = Color.Transparent
    End Sub
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        ...
        Else
            ...
            Form_venta.txt_rut_retira.Text = codigo
