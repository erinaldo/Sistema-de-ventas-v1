...
Public Class Form_recepcion_de_trabajo
    ...
    Sub cargar_combo_hardware()
        ...
        If DS3.Tables(DT3.TableName).Rows.Count > 0 Then
            For i = 0 To DS3.Tables(DT3.TableName).Rows.Count - 1
                ...
                For U = 0 To (CheckedListBox_hardware.Items.Count - 1)
                    If hardware = CheckedListBox_hardware.Items(U) Then
                        CheckedListBox_hardware.SetItemChecked(U, True)
                    End If
                Next
            Next
        End If
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Dim rect1 As New Rectangle(margen_izquierdo + 10, margen_superior + 85, margen_izquierdo + 780, margen_superior + 45)
        Dim rect2 As New Rectangle(margen_izquierdo + 10, margen_superior + 100, margen_izquierdo + 780, margen_superior + 60)
        ...
        e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 10, margen_superior + 200, margen_izquierdo + 810, margen_superior + 200)
        ...
        Dim rect_columna_1 As New Rectangle(margen_izquierdo + 10, margen_superior + 230, margen_izquierdo + 380, margen_superior + 130)
        Dim rect_columna_2 As New Rectangle(margen_izquierdo + 400, margen_superior + 230, margen_izquierdo + 410, margen_superior + 130)
        ...
        e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 10, margen_superior + 370, margen_izquierdo + 810, margen_superior + 370)

        e.Graphics.DrawString("HARDWARE A REVISAR:", Font_campos_superiores, Brushes.Black, margen_izquierdo + 10, margen_superior + 375)
        e.Graphics.DrawString(hardware, Font_campos_superiores, Brushes.Black, margen_izquierdo + 10, margen_superior + 390)

        e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 10, margen_superior + 470, margen_izquierdo + 300, margen_superior + 470)
        e.Graphics.DrawString("FIRMA", Font_campos_superiores, Brushes.Black, margen_izquierdo + 150, margen_superior + 475)

        e.Graphics.DrawString("TOTAL PRESUPUESTO", Font_campos_superiores, Brushes.Black, margen_izquierdo + 600, margen_superior + 460)
        e.Graphics.DrawString("PAGO PARCIAL", Font_campos_superiores, Brushes.Black, margen_izquierdo + 600, margen_superior + 475)

        e.Graphics.DrawString(":", Font_datos_empresa, Brushes.Black, margen_izquierdo + 730, margen_superior + 460)
        e.Graphics.DrawString(":", Font_datos_empresa, Brushes.Black, margen_izquierdo + 730, margen_superior + 475)

        e.Graphics.DrawString(total, Font_campos_superiores, Brushes.Black, margen_izquierdo + 810, margen_superior + 460, format1)
        e.Graphics.DrawString(pago_parcial, Font_campos_superiores, Brushes.Black, margen_izquierdo + 810, margen_superior + 475, format1)

        e.Graphics.DrawString("NOTA, EL SERVICIO TÉCNICO NO SE HACE RESPONSABLE DE LOS SIGUIENTES CASOS:", Font_datos_empresa, Brushes.Black, margen_izquierdo + 10, margen_superior + 490)
        e.Graphics.DrawString("● PÉRDIDA TOTAL O PARCIAL DE INFORMACIÓN ALMACENADA EN EL DISCO DURO.", Font_datos_empresa, Brushes.Black, margen_izquierdo + 10, margen_superior + 500)
        e.Graphics.DrawString("● ES RESPONSABILIDAD DEL CLIENTE TENER RESPALDADA ADECUADAMENTE LA INFORMACIÓN.", Font_datos_empresa, Brushes.Black, margen_izquierdo + 10, margen_superior + 510)
        e.Graphics.DrawString("● ROTURAS EN LOS SELLOS DE GARANTÍA POR INTERVENCIONES DE TERCEROS.", Font_datos_empresa, Brushes.Black, margen_izquierdo + 10, margen_superior + 520)
        e.Graphics.DrawString("● EL CLIENTE TIENE UN PLAZO DE 30 DÍAS PARA RETIRAR EL EQUIPO DESDE LA FECHA DE ACEPTACIÓN DEL PRESUPUESTO EN REPARACIÓN.", Font_datos_empresa, Brushes.Black, margen_izquierdo + 10, margen_superior + 530)
        e.Graphics.DrawString("● SI NO TENDRÁ QUE CANCELAR UN BODEGAJE DE 0,05 UF POR DÍA MÁS $3000 PESOS DE COSTOS POR EL TRASLADO A BODEGA.", Font_datos_empresa, Brushes.Black, margen_izquierdo + 10, margen_superior + 540)
        e.Graphics.DrawString("● EL SERVICIO TÉCNICO DESPUÉS DE UN PLAZO DE 60 DÍAS NO SE HACE RESPONSABLE DE DAÑOS, PERDIDAS PARCIALES O TOTALES DEL PRODUCTO.", Font_datos_empresa, Brushes.Black, margen_izquierdo + 10, margen_superior + 550)
    End Sub
End Class