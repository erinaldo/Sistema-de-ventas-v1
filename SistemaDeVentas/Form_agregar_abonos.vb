...
Public Class Form_agregar_abonos
    ...
    Private Sub Form_agregar_abonos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_menu_principal.WindowState = FormWindowState.Normal
    End Sub

    Private Sub Form_agregar_abonos_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_agregar_abonos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dtp_emision.Text = Form_menu_principal.dtp_fecha.Text
        dtp_emision.Value = Form_menu_principal.dtp_fecha.Text
                                                    ...
                                                    DS.Tables(DT.TableName).Rows(i).Item("recinto"), _
                                                     mifecha_vencimiento2, _
                                                      DS.Tables(DT.TableName).Rows(i).Item("total"), _
                                                       DS.Tables(DT.TableName).Rows(i).Item("saldo"), _
                                                        DS.Tables(DT.TableName).Rows(i).Item("saldo") + Val(txt_total_deuda.Text), _
                                                         DS.Tables(DT.TableName).Rows(i).Item("recinto"), _
    ...
    Private Sub DocImprimir_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        If txt_rut.Text.Contains("PROPIEDAD") = False Then
            ...
            If mirutempresa = "87686300-6" Then
                ...
                e.Graphics.DrawString(txt_rut.Text + " (FOLIO " + txt_folio.Text + ")", Font_texto_cabecera, Brushes.Black, margen_izquierdo + 100, margen_superior + 275)
            Else
                e.Graphics.DrawString("RUT CLIENTE", Font_texto_cabecera, Brushes.Black, margen_izquierdo + 0, margen_superior + 275)
                e.Graphics.DrawString(":", Font_texto_cabecera, Brushes.Black, margen_izquierdo + 90, margen_superior + 275)
                e.Graphics.DrawString(txt_rut.Text, Font_texto_cabecera, Brushes.Black, margen_izquierdo + 100, margen_superior + 275)
            End If
            ...
            e.Graphics.DrawString(txt_nombre_cliente.Text, Font_texto_cabecera, Brushes.Black, margen_izquierdo + 100, margen_superior + 290)
            ...
            e.Graphics.DrawString(combo_condiciones.Text, Font_texto_cabecera, Brushes.Black, margen_izquierdo + 100, margen_superior + 305)
            ...
            e.Graphics.DrawString(txt_detalle_ingreso.Text, Font_texto_cabecera, Brushes.Black, margen_izquierdo + 100, margen_superior + 320)
            ...
            e.Graphics.DrawString(minombre, Font_texto_cabecera, Brushes.Black, margen_izquierdo + 100, margen_superior + 335)
            ...
            e.Graphics.DrawString(txt_direccion.Text, Font_texto_cabecera, Brushes.Black, margen_izquierdo + 100, margen_superior + 350)
            ...
            e.Graphics.DrawString("TOTAL INGRESO: " & txt_total_abono_millar.Text, Font_texto_totales, Brushes.Black, margen_izquierdo + 270, margen_superior + numero_lineas + 435, format1)
