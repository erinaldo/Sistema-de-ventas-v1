...
Public Class Form_buscador_productos_registro_compras
    ...
    Private Sub Form_buscar_productos_registro_compras_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_registro_productos_compra.Enabled = True
        Form_registro_productos_compra.WindowState = FormWindowState.Normal
        Form_registro_productos_compra.btn_buscar.Focus()
    End Sub

    Private Sub Form_buscar_productos_registro_compras_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
        txt_busqueda.Focus()
        Timer_inactividad_buscar_productos_registro_compras.Start()
    End Sub

    Private Sub Form_buscar_productos2_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
    ...
    Private Sub migrilla_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles grilla_buscador_productos.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            Form_registro_productos_compra.txt_codigo.Text = codigo
            ' Form_registro_productos_compra.mostrar_datos_productos()
            ' Form_registro_productos_compra.controles(False, True)
            Form_registro_productos_compra.btn_modificar.PerformClick()
            Me.Close()
        End If
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles grilla_buscador_productos.DoubleClick
        ...
        Form_Compra.txt_precio_unitario_producto.Focus()
    ...
    Private Sub Timer_inactividad_buscar_productos_ventas_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer_inactividad_buscar_productos_registro_compras.Tick
