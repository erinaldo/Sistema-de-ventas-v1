...
Public Class Form_buscador_clientes_ventas
    ...
    Sub mostrar_datos_clientes()
        ...
        If DS.Tables(DT.TableName).Rows.Count = 1 Then
            ...
            'Form_venta.txt_cupo.Text = Val(DS.Tables(DT.TableName).Rows(0).Item("cupo_cliente")) - Val(DS.Tables(DT.TableName).Rows(0).Item("saldo_cliente"))
            Form_venta.txt_cupo.Text = DS.Tables(DT.TableName).Rows(0).Item("cupo_cliente")
            ...
            'If Form_venta.Combo_venta.Text = "GUIA" Then
            '    If Form_venta.combo_condiciones.Text = "CREDITO" Then
            '        Form_venta.txt_porcentaje_desc.Enabled = False
            '        Form_venta.txt_porcentaje_desc.Text = Form_venta.txt_descuento_cliente.Text
            '    Else
            '        Form_venta.txt_porcentaje_desc.Enabled = True
            '        Form_venta.txt_porcentaje_desc.Text = valor_descuento_ventas
            '    End If
            'End If
