...
Public Class Form_buscador_clientes_registro_clientes
    ...
    Private Sub Form_buscar_clientes_registro_clientes_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub Form_buscar_clientes_registro_clientes_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_clientes_registro_clientes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        ...
        Else
            ...
            form_registro_clientes.txt_rut.Text = codigo
    ...
    Sub mostrar_datos_clientes()
        ...
        If DS.Tables(DT.TableName).Rows.Count = 1 Then
            ...
            '   form_registro_clientes.txt_ciudad.Text = DS.Tables(DT.TableName).Rows(0).Item("ciudad_cliente")
