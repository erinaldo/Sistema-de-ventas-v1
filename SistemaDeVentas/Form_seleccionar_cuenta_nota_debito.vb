...
Public Class Form_seleccionar_cuenta_nota_debito

    Private Sub Form_seleccionar_cuenta_nota_debito_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_nota_de_debito.WindowState = FormWindowState.Normal
        Form_nota_de_debito.Enabled = True
        Form_nota_de_debito.txt_rut_cliente.Focus()
    End Sub

    Private Sub Form_seleccionar_cuenta_nota_debito_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_seleccionar_cuenta_nota_debito_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
        mostrar_malla()
    ...
    Sub mostrar_malla()
        ...
        RUT = Form_nota_de_debito.txt_rut_cliente.Text
        conexion.Close()
        DS4.Tables.Clear()
        DT4.Rows.Clear()
        DT4.Columns.Clear()
    ...
    Private Sub grilla_clientes_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles grilla_clientes.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            If grilla_clientes.Rows.Count <= 0 Then
                Me.Close()
                Form_nota_de_debito.txt_codigo.Focus()
                Me.Close()
            Else
                codigo = grilla_clientes.CurrentRow.Cells(0).Value
                rut = grilla_clientes.CurrentRow.Cells(1).Value

                Form_nota_de_debito.limpiar_datos_clientes_enter()
                Form_nota_de_debito.txt_rut_cliente.Text = codigo
    ...
    Sub mostrar_datos_clientes()
        ...
        If DS.Tables(DT.TableName).Rows.Count = 1 Then
            Form_nota_de_debito.lbl_rut.Text = DS.Tables(DT.TableName).Rows(0).Item("rut_cliente")
            Form_nota_de_debito.txt_rut_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("rut_cliente")
            Form_nota_de_debito.txt_nombre_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("nombre_cliente")
            Form_nota_de_debito.txt_direccion_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("direccion_cliente")
            Form_nota_de_debito.txt_cod_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("cod_cliente")
            Form_nota_de_debito.txt_descuento_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("descuento_1")
            Form_nota_de_debito.txt_giro_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("giro_cliente")
            Form_nota_de_debito.txt_comuna_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("comuna_cliente")
            Form_nota_de_debito.txt_telefono.Text = DS.Tables(DT.TableName).Rows(0).Item("telefono_cliente")
            Form_nota_de_debito.txt_cuenta_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("estado_cuenta")
            Form_nota_de_debito.txt_folio.Text = DS.Tables(DT.TableName).Rows(0).Item("folio_cliente")

            Form_nota_de_debito.txt_correo_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("email_cliente")
            Form_nota_de_debito.txt_ciudad_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("ciudad_cliente")
