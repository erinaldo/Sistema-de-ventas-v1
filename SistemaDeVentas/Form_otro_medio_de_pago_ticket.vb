...
Public Class Form_otro_medio_de_pago_ticket

    Private Sub Form_otro_medio_de_pago_ticket_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        If txt_medio_pago.Text = "" Then
            Form_ticket_ventas.combo_condiciones.SelectedItem = "-"
        End If
        Form_ticket_ventas.WindowState = FormWindowState.Normal
        Form_ticket_ventas.Enabled = True
    End Sub

    Private Sub Form_otro_medio_de_pago_ticket_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_otro_medio_de_pago_ticket_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    End Sub
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        ...
        Form_ticket_ventas.combo_condiciones.Items.Add(txt_medio_pago.Text)
        Form_ticket_ventas.combo_condiciones.SelectedItem = txt_medio_pago.Text
        Me.Close()
    End Sub
