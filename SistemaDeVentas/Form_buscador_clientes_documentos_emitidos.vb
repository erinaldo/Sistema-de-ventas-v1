...
Public Class Form_buscador_clientes_documentos_emitidos
    Dim mitexto As String
    Dim micampo As String

    Dim consulta_busqueda As String
    Private Sub Form_buscar_clientes_documentos_emitidos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed

        Form_mis_documentos.WindowState = FormWindowState.Normal
        Form_mis_documentos.Enabled = True
        Form_mis_documentos.txt_rut_cliente.Focus()

    End Sub

    Private Sub Form_buscar_clientes_documentos_emitidos_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_clientes_documentos_emitidos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    End Sub
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        ...
        '        Form_agregar_abonos.llenar_combo_facturas()
        '        Form_agregar_abonos.cargar_documentos_vencidos()
        ...
        '    If migrilla.Rows.Count <= 0 Then
        '        Me.Close()
        '        Form_agregar_abonos_2.txt_rut.Focus()
        '        Me.Close()
        '    Else
        '        codigo = migrilla.CurrentRow.Cells(0).Value
        '        Form_agregar_abonos_2.limpiar_datos_cliente()
        '        Form_agregar_abonos_2.txt_rut.Text = codigo
        '        mostrar_datos_clientes()


        '        Form_agregar_abonos_2.Combo_cuotas.Items.Clear()

        '        Form_agregar_abonos_2.llenar_combo_cuotas_pendientes()

        '        Form_agregar_abonos_2.mostrar_datos_clientes()

        '        Form_ver_pagos.Close()

        '        Form_agregar_abonos_2.mostrar_malla()

        '        Form_agregar_abonos_2.pago_vencido()
        '        Form_agregar_abonos_2.revizar_vencimiento()
    ...
    Private Sub migrilla_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles migrilla.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Else
                codigo = migrilla.CurrentRow.Cells(0).Value
                Form_mis_documentos.txt_nombre_cliente.Text = ""
                Form_mis_documentos.txt_rut_cliente.Text = codigo
                Form_mis_documentos.mostrar_datos_clientes()
                Form_mis_documentos.busqueda()
                Form_mis_documentos.txt_rut_cliente.Focus()
                Me.Close()
            End If
        End If
