...
Public Class Form_abonos_listado_propiedades
    ...
    Private Sub Form_abonos_listado_propiedades_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Form_menu_principal.WindowState = FormWindowState.Normal
    End Sub

    Private Sub Form_abonos_listado_propiedades_KeyUp(sender As Object, e As KeyEventArgs) Handles MyBase.KeyUp
    ...
    Private Sub Form_abonos_listado_propiedades_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        cargar_logo()
        fecha()
        mostrar_malla()
        mostrar_impresora()
    ...
    Sub mostrar_malla()
        ...
        If txt_nombre_cliente.Text = "" Then
            ...
            SC3.CommandText = "select fecha as 'FECHA', n_abono as 'NRO.', condicion_abono as 'CONDIC.', detalle_abono as 'DETALLE',  estado as 'ESTADO', nombre as 'CLIENTE', abono.rut_cliente as 'RUT', monto_abono as 'TOTAL', nombre_usuario as 'USUARIO' from abono, usuarios  where abono.rut_cliente like '%PROPIEDAD%' and fecha >='" & (mifecha2) & "' and fecha <= '" & (mifecha4) & "' and abono.usuario_responsable=usuarios.rut_usuario group by n_abono order by n_abono asc"
    ...
    Sub cargar_abono()
        ...
        If DS2.Tables(DT2.TableName).Rows.Count > 0 Then
            ...
            For i = 0 To DS2.Tables(DT2.TableName).Rows.Count - 1
                grilla_abono.Rows.Add(DS2.Tables(DT2.TableName).Rows(i).Item("tipo_documento"),
                                                 DS2.Tables(DT2.TableName).Rows(i).Item("nro_documento"),
                                                  DS2.Tables(DT2.TableName).Rows(i).Item("monto_abono"),
                                                   DS2.Tables(DT2.TableName).Rows(i).Item("saldo_documento"),
                                                    "INGRESADO")
            Next
