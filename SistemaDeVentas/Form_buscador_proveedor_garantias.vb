...
Public Class Form_buscador_proveedor_garantias
    ...
    Private Sub Form_buscar_proveedor_garantias_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_guias_traslado_a_proveedores.WindowState = FormWindowState.Normal
        Form_guias_traslado_a_proveedores.Enabled = True
    End Sub

    Private Sub Form_buscar_proveedor_garantias_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_proveedor_garantias_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        ...
        If migrilla.Rows.Count <= 0 Then
            Form_guias_traslado_a_proveedores.txt_rut_cliente.Focus()
            Me.Close()
        Else
            codigo = migrilla.CurrentRow.Cells(0).Value
            Form_guias_traslado_a_proveedores.limpiar_datos_clientes()
            Form_guias_traslado_a_proveedores.txt_rut_cliente.Text = codigo
            mostrar_datos_clientes()
            Form_guias_traslado_a_proveedores.limpiar_datos_clientes_retira()
            Form_guias_traslado_a_proveedores.calcular_totales()
            Me.Close()
        End If
    End Sub
    ...
    Private Sub migrilla_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles migrilla.KeyPress
        ...
        '    If migrilla.Rows.Count <= 0 Then
        '        Me.Close()
        '        Form_guias_traslado_a_proveedores.txt_codigo.Focus()
        '        Me.Close()
        '    Else
        '        codigo = migrilla.CurrentRow.Cells(0).Value
        '        Form_guias_traslado_a_proveedores.limpiar_datos_clientes_enter()
        '        Form_guias_traslado_a_proveedores.txt_rut.Text = codigo
        '        Form_guias_traslado_a_proveedores.txt_descto.Text = "0"
        '        Form_guias_traslado_a_proveedores.mostrar_datos_clientes()
        '        ' Form_guias_traslado_a_proveedores.llenar_combo_retira()
        '        Form_guias_traslado_a_proveedores.limpiar_datos_clientes_retira()
        '        Form_guias_traslado_a_proveedores.guardar_descuento()
        '        Form_guias_traslado_a_proveedores.grilla_detalle.Rows.Clear()
        '        Form_guias_traslado_a_proveedores.cargar_descuento()
        '        Form_guias_traslado_a_proveedores.calcular_totales()
        '        Me.Close()
        '    End If
        'End If
    ...
    Sub mostrar_datos_clientes()
        ...
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
            ...
            Form_guias_traslado_a_proveedores.txt_rut_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("rut_proveedor")
            Form_guias_traslado_a_proveedores.txt_nombre_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("nombre_proveedor")
            Form_guias_traslado_a_proveedores.txt_direccion_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("direccion_proveedor")
            'txt_cod_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("cod_auto")
            Form_guias_traslado_a_proveedores.txt_giro_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("giro_proveedor")
            Form_guias_traslado_a_proveedores.txt_comuna_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("comuna_proveedor")
            Form_guias_traslado_a_proveedores.txt_telefono.Text = DS.Tables(DT.TableName).Rows(0).Item("telefono_proveedor")
            Form_guias_traslado_a_proveedores.txt_correo_cliente.Text = DS.Tables(DT.TableName).Rows(0).Item("email_proveedor")
