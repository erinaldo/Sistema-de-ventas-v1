...
Public Class Form_Compra
    ...
    Dim Total_factura_compra As Long
    ...
    Private Sub Form_Compra_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        'If Check_medida.Checked = True Then
        'grilla_detalle.Columns(17).Visible = True
        'Else
        grilla_detalle.Columns(17).Visible = False
        'End If
        ...
        'GroupBox_columnas.Location = New Point(5000, 5000)
    ...
    Sub cargar_compra_temporal()
        ...
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
            ...
            For i = 0 To DS.Tables(DT.TableName).Rows.Count - 1
                ...
                grilla_detalle.Rows.Add(DS.Tables(DT.TableName).Rows(i).Item("COD_PRODUCTO"),
                                         DS.Tables(DT.TableName).Rows(i).Item("NOMBRE"),
                                          DS.Tables(DT.TableName).Rows(i).Item("CANTIDAD"),
                                           DS.Tables(DT.TableName).Rows(i).Item("PRECIO_UNITARIO"),
                                            DS.Tables(DT.TableName).Rows(i).Item("VALOR_UNITARIO"),
                                             DS.Tables(DT.TableName).Rows(i).Item("DESCUENTO"),
                                              DS.Tables(DT.TableName).Rows(i).Item("DESCUENTO_2"),
                                               DS.Tables(DT.TableName).Rows(i).Item("DESCUENTO_3"),
                                                DS.Tables(DT.TableName).Rows(i).Item("NETO"),
                                                 DS.Tables(DT.TableName).Rows(i).Item("IVA"),
                                                  DS.Tables(DT.TableName).Rows(i).Item("TOTAL"),
                                                   DS.Tables(DT.TableName).Rows(i).Item("FACTOR"),
                                                    DS.Tables(DT.TableName).Rows(i).Item("PRECIO_venta"),
                                                     DS.Tables(DT.TableName).Rows(i).Item("MARGEN"),
                                                      DS.Tables(DT.TableName).Rows(i).Item("estado_ingreso"),
                                                       DS.Tables(DT.TableName).Rows(i).Item("precio_anterior"),
                                                        tipo_medida,
    ...
    Sub controles(ByVal a As Boolean, ByVal b As Boolean)
        ...
        GroupBox1_diferencia.Enabled = a
    ...
    Sub datos_producto_venta()
        ...
        If Radio_margen.Checked = True Then
            ...
            Try
                ...
                precio_venta = Val(txt_costo_actual.Text) * (valor_iva_margen)
    ...
    Sub grabar_factura()
        ...
        If combo_documento.Text = "FACTURA ELECTRONICA" Then
            ...
            Else
                SC.Connection = conexion
                SC.CommandText = "insert into compra (n_compra, tipo, tipo_emision, rut_proveedor, neto, iva, total, fecha_emision, fecha_vencimiento, fecha_ingreso, estado, usuario_responsable, codigo_compra, hora, total_automatico, diferencia, porcentaje_diferencia) values (" & (txt_nro_doc.Text) & " , 'FACTURA',  'ELECTRONICA', '" & (txt_rut_proveedor.Text) & "', " & (txt_neto.Text) & ", " & (txt_iva.Text) & "," & (txt_total.Text) & ", '" & (mifecha2) & "','" & (mifecha2) & "','" & (Form_menu_principal.dtp_fecha.Text) & "','IMPAGA','" & (miusuario) & "','" & (txt_codigo_compra.Text) & "','" & (Form_menu_principal.lbl_hora.Text) & "','" & (txt_total_ingresado.Text) & "','" & (txt_diferencia.Text) & "','" & (txt_porcentaje.Text) & "')"
                DA.SelectCommand = SC
                DA.Fill(DT)
            End If
        End If
        ...
        If combo_documento.Text = "FACTURA MANUAL" Then
            ...
            Else
                SC.Connection = conexion
                SC.CommandText = "insert into compra (n_compra, tipo, tipo_emision, rut_proveedor, neto, iva, total, fecha_emision, fecha_vencimiento, fecha_ingreso, estado, usuario_responsable, codigo_compra, hora, total_automatico, diferencia, porcentaje_diferencia) values (" & (txt_nro_doc.Text) & " , 'FACTURA',  'MANUAL', '" & (txt_rut_proveedor.Text) & "', " & (txt_neto.Text) & ", " & (txt_iva.Text) & "," & (txt_total.Text) & ", '" & (mifecha2) & "','" & (mifecha2) & "','" & (Form_menu_principal.dtp_fecha.Text) & "','IMPAGA','" & (miusuario) & "','" & (txt_codigo_compra.Text) & "','" & (Form_menu_principal.lbl_hora.Text) & "','" & (txt_total_ingresado.Text) & "','" & (txt_diferencia.Text) & "','" & (txt_porcentaje.Text) & "')"
                DA.SelectCommand = SC
                DA.Fill(DT)
            End If
        End If
        ...
        ' total_automatico = '" & (txt_total_ingresado.Text) & "',diferencia='" & (txt_diferencia.Text) & "',porcentaje_diferencia='" & (txt_porcentaje.Text) & "'
        ...
        If combo_documento.Text = "GUIA ELECTRONICA" Then
            ...
            Else
                ...
                SC.Connection = conexion
                SC.CommandText = "insert into compra (n_compra, tipo, tipo_emision, rut_proveedor, neto, iva, total, fecha_emision, fecha_vencimiento, fecha_ingreso, estado, usuario_responsable, codigo_compra, hora, total_automatico, diferencia, porcentaje_diferencia) values (" & (txt_nro_doc.Text) & " , 'GUIA',  'ELECTRONICA', '" & (txt_rut_proveedor.Text) & "', " & (txt_neto.Text) & ", " & (txt_iva.Text) & "," & (txt_total.Text) & ", '" & (mifecha2) & "','" & (mifecha2) & "','" & (Form_menu_principal.dtp_fecha.Text) & "','IMPAGA','" & (miusuario) & "','" & (txt_codigo_compra.Text) & "','" & (Form_menu_principal.lbl_hora.Text) & "','" & (txt_total_ingresado.Text) & "','" & (txt_diferencia.Text) & "','" & (txt_porcentaje.Text) & "')"
                DA.SelectCommand = SC
                DA.Fill(DT)
            End If
        End If
        ...
        If combo_documento.Text = "GUIA MANUAL" Then
            ...
            Else
                ...
                SC.Connection = conexion
                SC.CommandText = "insert into compra (n_compra, tipo, tipo_emision, rut_proveedor, neto, iva, total, fecha_emision, fecha_vencimiento, fecha_ingreso, estado, usuario_responsable, codigo_compra, hora, total_automatico, diferencia, porcentaje_diferencia) values (" & (txt_nro_doc.Text) & " , 'GUIA',  'MANUAL', '" & (txt_rut_proveedor.Text) & "', " & (txt_neto.Text) & ", " & (txt_iva.Text) & "," & (txt_total.Text) & ", '" & (mifecha2) & "','" & (mifecha2) & "','" & (Form_menu_principal.dtp_fecha.Text) & "','IMPAGA','" & (miusuario) & "','" & (txt_codigo_compra.Text) & "','" & (Form_menu_principal.lbl_hora.Text) & "','" & (txt_total_ingresado.Text) & "','" & (txt_diferencia.Text) & "','" & (txt_porcentaje.Text) & "')"
                DA.SelectCommand = SC
                DA.Fill(DT)
            End If
        End If
    ...
    Private Sub btn_grabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_grabar.Click
        ...
        If txt_porcentaje.Text > 0.5 Then
            valormensaje = MsgBox("EL TOTAL DEL DOCUMENTO NO COINCIDE CON EL TOTAL DE PRODUCTOS INGRESADOS ¿DESEA CONTINUAR?", MsgBoxStyle.YesNo + MsgBoxStyle.Exclamation, "ATENCION")

            If valormensaje = vbYes Then

            ElseIf valormensaje = vbNo Then
                Exit Sub
            End If
        End If
        ...
        '    Dim porcentaje_diferencia As Double
        '    porcentaje_diferencia = Total_factura_compra / txt_total.Text * 100
        '    porcentaje_diferencia = 100 - porcentaje_diferencia

        '    porcentaje_diferencia = porcentaje_diferencia.ToString("N2")

        '    If Total_factura_compra <> txt_total.Text Then
        '        valormensaje = MsgBox("EL TOTAL DEL DOCUMENTO NO COINCIDE CON EL TOTAL DE PRODUCTOS INGRESADOS ¿DESEA CONTINUAR?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "VERIFICAR DATOS DEL DOCUMENTO")
        ...
        '    If Total_factura_compra <> txt_neto.Text Then
        '        valormensaje = MsgBox("EL TOTAL DEL DOCUMENTO NO COINCIDE CON EL TOTAL DE PRODUCTOS INGRESADOS ¿DESEA CONTINUAR?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "VERIFICAR DATOS DEL DOCUMENTO")
    ...
    Private Sub txt_cantidad_agregar_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_cantidad_agregar.KeyPress
        ...
        If txt_medida.Text <> "DECIMAL" Then
            If Char.IsDigit(e.KeyChar) Then
                e.Handled = False
            ElseIf Char.IsControl(e.KeyChar) Then
                e.Handled = False
    ...
    Private Sub Radio_precio_venta_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Radio_precio_venta.CheckedChanged
        ...
        txt_precio_venta_producto.Text = "0"
        'txt_factor.Text = "0"
        txt_precio_venta_producto.Width = (75)
    ...
    Private Sub Radio_margen_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Radio_margen.CheckedChanged
        ...
        txt_cantidad_agregar.Focus()
        txt_precio_venta_producto.Text = "0"
        txt_precio_venta_producto.Width = (60)
    ...
    Sub calcular_totales()
        ...
        For i = 0 To grilla_detalle.Rows.Count - 1
            ...
            precio_unitario = Val(grilla_detalle.Rows(i).Cells(4).Value.ToString)

            totalgrilla = Val(cantidad) * Val(precio_unitario)
            Total_factura_compra = Val(Total_factura_compra) + Val(totalgrilla)
        Next

        txt_total_ingresado.Text = ""
        txt_total_ingresado.Text = Total_factura_compra
        ...
        Dim total_ingresado As Integer = 0
        ...
        If Radio_iva.Checked = True Then
            ...
            If txt_total.Text = "" Then
                total_ingresado = "0"
            Else
                total_ingresado = txt_total.Text
            End If

            txt_diferencia.Text = Val(total_ingresado) - Val(Total_factura_compra)

            Dim porcentaje_diferencia As Double
            porcentaje_diferencia = Total_factura_compra / total_ingresado * 100
            porcentaje_diferencia = 100 - porcentaje_diferencia
            porcentaje_diferencia = porcentaje_diferencia.ToString("N2")
            txt_porcentaje.Text = porcentaje_diferencia
        End If
        ...
        'If txt_total_ingresado.Text = "" Or txt_total_ingresado.Text = "0" Then
        '    txt_total_ingresado.Text = "0"
        'Else
        '    txt_total_ingresado.Text = Format(Int(txt_total_ingresado.Text), "###,###,###")
        'End If

        'If txt_diferencia.Text = "" Or txt_diferencia.Text = "0" Then
        '    txt_diferencia.Text = "0"
        'Else
        '    txt_diferencia.Text = Format(Int(txt_diferencia.Text), "###,###,###")
        'End If

        If txt_porcentaje.Text = "-Infinito" Then
            txt_porcentaje.Text = ""
        End If

        If txt_porcentaje.Text = "NeuN" Then
            txt_porcentaje.Text = ""
        End If
    ...
    Private Sub grilla_detalle_ClientSizeChanged(sender As Object, e As EventArgs) Handles grilla_detalle.ClientSizeChanged

    End Sub

    Private Sub Radio_neto_CheckedChanged_1(sender As Object, e As EventArgs) Handles Radio_neto.CheckedChanged
        lbl_total_ingresado.Text = "NETO:"
    End Sub

    Private Sub Radio_iva_CheckedChanged(sender As Object, e As EventArgs) Handles Radio_iva.CheckedChanged
        lbl_total_ingresado.Text = "TOTAL:"
    End Sub
End Class