...
Public Class Form_enviar_documento_2
    ...
    Private Sub Form_enviar_documento_2_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Form_envio_productos_sucursal.WindowState = FormWindowState.Normal
    End Sub

    Private Sub Form_enviar_documento_2_KeyUp(sender As Object, e As KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_enviar_documento_2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub cargar_compra()
        ...
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
            ...
            For i = 0 To DS.Tables(DT.TableName).Rows.Count - 1
                Me.grilla_detalle.Rows.Add(DS.Tables(DT.TableName).Rows(i).Item("COD_PRODUCTO"),
                                            DS.Tables(DT.TableName).Rows(i).Item("NOMBRE"),
                                             DS.Tables(DT.TableName).Rows(i).Item("CANTIDAD"),
                                              DS.Tables(DT.TableName).Rows(i).Item("CANTIDAD"),
                                              DS.Tables(DT.TableName).Rows(i).Item("PRECIO_UNITARIO"),
                                               DS.Tables(DT.TableName).Rows(i).Item("VALOR_UNITARIO"),
                                                DS.Tables(DT.TableName).Rows(i).Item("DESCUENTO"),
                                                 DS.Tables(DT.TableName).Rows(i).Item("DESCUENTO2"),
                                                  DS.Tables(DT.TableName).Rows(i).Item("DESCUENTO3"),
                                                   DS.Tables(DT.TableName).Rows(i).Item("NETO"),
                                                    DS.Tables(DT.TableName).Rows(i).Item("IVA"),
                                                     DS.Tables(DT.TableName).Rows(i).Item("TOTAL"),
                                                      DS.Tables(DT.TableName).Rows(i).Item("FACTOR"),
