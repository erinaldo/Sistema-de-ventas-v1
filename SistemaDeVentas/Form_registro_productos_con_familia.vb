...
Public Class Form_registro_productos_con_familia
    ...
    Private Sub Form_registro_productos_con_familia_KeyUp(sender As Object, e As KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_registro_productos_con_familia_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Form_menu_principal.WindowState = FormWindowState.Normal
    End Sub

    Private Sub Form_registro_productos_con_familia_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Width = 639
        Me.Height = 448
        Centrar()
    ...
    Private Sub txt_cantidad_minima_KeyPress1(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Char.IsDigit(e.KeyChar) Then
            e.Handled = False
        ElseIf Char.IsControl(e.KeyChar) Then
            e.Handled = False
    ...
    Private Sub txt_nombre_proveedor_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        e.KeyChar = e.KeyChar.ToString.ToUpper
        If e.KeyChar = ";" Then
            e.KeyChar = ""
        End If
    ...
    Private Sub txt_nombre_proveedor_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub txt_costo_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub txt_factor_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        e.KeyChar = e.KeyChar.ToString.ToUpper
        If e.KeyChar = ";" Then
            e.KeyChar = ""
        End If
    ...
    Private Sub btn_sugerir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub txt_cantidad_ultima_compra_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        e.KeyChar = e.KeyChar.ToString.ToUpper
        If e.KeyChar = ";" Then
            e.KeyChar = ""
        End If
    ...
    Private Sub txt_cantidad_ultima_compra_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub txt_nro_doc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub txt_tipo_doc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        e.KeyChar = e.KeyChar.ToString.ToUpper
        If e.KeyChar = ";" Then
            e.KeyChar = ""
        End If
    ...
    Private Sub txt_tipo_doc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub Combo_tipo_precio_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btn_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        ...
        If VarSeleccionproducto = 1 Then
            ...
            Else
                ...
                SC.Connection = conexion
                SC.CommandText = "INSERT INTO productos(cod_producto, nombre, marca, aplicacion, numero_tecnico, familia, subfamilia, subfamilia_dos, codigo_barra, ultima_compra, fecha_modificacion, margen, numero_proveedor, tipo_precio, estado_producto, activo) VALUES ('" & (txt_codigo.Text) & "','" & (txt_nombre.Text) & "','" & (txt_marca.Text) & "','" & (txt_aplicacion.Text) & "','" & (txt_numero_tecnico.Text) & "','" & (txt_codigo_familia.Text) & "','" & (txt_codigo_subfamilia.Text) & "','" & (txt_codigo_subfamilia_2.Text) & "','" & (txt_codigo_barra.Text) & "', '" & (mifecha2) & "', '" & (Form_menu_principal.dtp_fecha.Text) & "', '0', '-', '0', '-', '" & (Combo_activo.Text) & "')"
                DA.SelectCommand = SC
                DA.Fill(DT)
