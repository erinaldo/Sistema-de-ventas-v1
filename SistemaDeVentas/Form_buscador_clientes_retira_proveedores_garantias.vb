...
Public Class Form_buscador_clientes_retira_proveedores_garantias
    Dim campo_nombre As String
    Dim campo_apellido As String
    Dim consulta_busqueda As String
    Private Sub Form_buscador_proveedores_garantiasvb_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_guias_traslado_a_proveedores.Enabled = True
        Form_guias_traslado_a_proveedores.txt_rut_retira.Focus()
    End Sub

    Private Sub Form_buscador_proveedores_garantiasvb_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscador_proveedores_garantiasvb_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        ...
        Else
            ...
            Form_guias_traslado_a_proveedores.txt_rut_retira.Text = codigo
            Form_guias_traslado_a_proveedores.mostrar_datos_retira()
            Me.Close()
        End If
    End Sub
