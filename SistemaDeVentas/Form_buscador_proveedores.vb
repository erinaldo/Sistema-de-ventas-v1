...
Public Class Form_buscador_proveedores

    Dim consulta_busqueda As String

    Private Sub form_buscar_proveedores_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        form_registro_proveedores.WindowState = FormWindowState.Normal
        form_registro_proveedores.Enabled = True
    End Sub

    Private Sub form_buscar_proveedores_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub form_buscar_proveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Private Sub migrilla_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles migrilla.DoubleClick
        ...
        If migrilla.Rows.Count <= 0 Then
            form_registro_proveedores.txt_rut.Focus()
            Me.Close()
        Else
            codigo = migrilla.CurrentRow.Cells(0).Value
            form_registro_proveedores.LIMPIAR()
            form_registro_proveedores.txt_rut.Text = codigo
    ...
    Sub MOSTRAR_DATOS_PROVEEDOR()
        ...
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
            form_registro_proveedores.txt_rut.Text = DS.Tables(DT.TableName).Rows(0).Item("RUT_PROVEEDOR")
            form_registro_proveedores.txt_nombre.Text = DS.Tables(DT.TableName).Rows(0).Item("NOMBRE_PROVEEDOR")
            form_registro_proveedores.txt_direccion.Text = DS.Tables(DT.TableName).Rows(0).Item("DIRECCION_PROVEEDOR")
            form_registro_proveedores.txt_telefono.Text = DS.Tables(DT.TableName).Rows(0).Item("TELEFONO_PROVEEDOR")
            form_registro_proveedores.txt_email.Text = DS.Tables(DT.TableName).Rows(0).Item("EMAIL_PROVEEDOR")
            'form_registro_proveedores.txt_ciudad.Text = DS.Tables(DT.TableName).Rows(0).Item("CIUDAD_PROVEEDOR")
            form_registro_proveedores.txt_comuna.Text = DS.Tables(DT.TableName).Rows(0).Item("COMUNA_PROVEEDOR")
            form_registro_proveedores.txt_giro.Text = DS.Tables(DT.TableName).Rows(0).Item("GIRO_PROVEEDOR")
            form_registro_proveedores.txt_representante.Text = DS.Tables(DT.TableName).Rows(0).Item("REPRESENTANTE_PROVEEDOR")
            form_registro_proveedores.txt_credito.Text = DS.Tables(DT.TableName).Rows(0).Item("CREDITO_PROVEEDOR")
