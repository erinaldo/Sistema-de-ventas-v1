...
Public Class Form_registro_cliente_retira_ventas

    Dim VarSeleccion As Integer
    Dim MiPos As Integer

    Private Sub Form_registro_cliente_retira_ventas_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_venta.Enabled = True
        Form_venta.WindowState = FormWindowState.Normal
        Form_venta.txt_rut_retira.Focus()
    End Sub

    Private Sub Form_registro_cliente_retira_ventas_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Form_venta.Enabled = True
        Form_venta.WindowState = FormWindowState.Normal
    End Sub

    Private Sub Form_registro_cliente_retira_ventas_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    'seleccionamos el actualizar tabla de los cloentes que retiran documentos.
    'mostramos la grilla de todos los clientes que retiran documentos.
    'cambiamos el estado de los controles.
    'llenamos el combo rut para seleccionar el cliente al que pertenece quien retirara el documento.
    Private Sub Form_cliente_retira_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        conexion.Close()
    ...
    Private Sub btn_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        ...
        If VarSeleccion = 1 Then
            ...
            Form_venta.txt_rut_retira.Text = txt_rut_cliente_retira.Text
            Form_venta.mostrar_datos_retira()
            Me.Close()
        End If
    ...
    Private Sub Timer_registros_clientes_retira_ventas_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer_registros_clientes_retira_ventas.Tick
