...
Public Class Form_buscador_productos_registro
    ...
    Private Sub Form_buscar_productos_registro_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        form_registro_productos.Enabled = True
        form_registro_productos.WindowState = FormWindowState.Normal
        form_registro_productos.txt_codigo.Focus()
    End Sub

    Private Sub Form_buscar_productos_registro_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
    ...
    Private Sub Form_buscar_productos_registro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
        txt_busqueda.Focus()
        'Timer_inactividad_buscar_productos_ventas.Start()
    End Sub

    Private Sub grilla_buscador_productos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles grilla_buscador_productos.DoubleClick
        ...
        form_registro_productos.txt_codigo.Text = codigo
        form_registro_productos.mostrar_datos_productos()
        form_registro_productos.mostrar_datos_proveedores()
        form_registro_productos.controles(False, True)
        Me.Close()
        '   End If
    End Sub
