...
Public Class Form_autorizacion
    ...
    Private Sub DocImprimir_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        If tipo_impresion_sistema = "TICKET" Then
            ...
            mifecha = Form_venta.dtp_fecha.Text
        ...
        If Form_venta.Combo_venta.Text = "BOLETA" Then
            e.Graphics.DrawString(Form_venta.dtp_fecha.Text & " " & mirecintoempresa, Font10, Brushes.Black, 85, 5)
        ...
        If Form_venta.Combo_venta.Text = "FACTURA" Then
            ...
            e.Graphics.DrawString(Form_venta.dtp_fecha.Text & " " & mirecintoempresa, Font10, Brushes.Black, 85, 10)
            ...
            e.Graphics.DrawString(Form_venta.dtp_fecha.Text, Font8, Brushes.Black, 40, 755)
        ...
        If Form_venta.Combo_venta.Text = "GUIA" Then
            ...
            e.Graphics.DrawString(Form_venta.dtp_fecha.Text & " " & mirecintoempresa, Font10, Brushes.Black, 100, 20)
            ...
            e.Graphics.DrawString(Form_venta.dtp_fecha.Text, Font8, Brushes.Black, 797, 540, format1)
