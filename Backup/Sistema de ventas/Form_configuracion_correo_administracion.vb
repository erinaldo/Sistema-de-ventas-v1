Public Class Form_configuracion_correo_administracion

    Private Sub Form_configuracion_correo_administracion_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_menu_principal.WindowState = FormWindowState.Maximized
    End Sub

    Private Sub Form_configuracion_correo_administracion_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_configuracion_correo_administracion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        ...
        SC.Connection = conexion
        SC.CommandText = "DELETE FROM `correo_de_administracion`"
        DA.SelectCommand = SC
        DA.Fill(DT)

        SC.Connection = conexion
        SC.CommandText = "INSERT INTO `correo_de_administracion` (`correo`, `clave_correo`, `seguridad_ssl`, `puerto_smtp`, `servidor_smtp`) VALUES ('" & (txt_email.Text) & "', '" & (txt_clave_email.Text) & "', '" & (combo_seguridad_ssl.Text) & "', '" & (txt_puerto_smtp.Text) & "', '" & (txt_servidor_smtp.Text) & "');"
        DA.SelectCommand = SC
        DA.Fill(DT)
