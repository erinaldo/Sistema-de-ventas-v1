...
Public Class Form_mis_reservas
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("CODIGO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 50, margen_superior + 150)
        e.Graphics.DrawString("NOMBRE", Font_titulo_columna, Brushes.Black, margen_izquierdo + 100, margen_superior + 150)
        e.Graphics.DrawString("NRO. TECNICO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 270, margen_superior + 150)
        e.Graphics.DrawString("CANTIDAD", Font_titulo_columna, Brushes.Black, margen_izquierdo + 500, margen_superior + 150, format1)
        e.Graphics.DrawString("PRECIO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 570, margen_superior + 150, format1)
        e.Graphics.DrawString("TOTAL", Font_titulo_columna, Brushes.Black, margen_izquierdo + 640, margen_superior + 150, format1)
        e.Graphics.DrawString("FECHA", Font_titulo_columna, Brushes.Black, margen_izquierdo + 660, margen_superior + 150)
        e.Graphics.DrawString("VENDEDOR", Font_titulo_columna, Brushes.Black, margen_izquierdo + 730, margen_superior + 150)
        ...
        For i = numero_lineas_total To grilla_mis_pedidos.Rows.Count - 1
            ...
            e.Graphics.DrawString(codigo_detalle, Font_texto_impresion, Brushes.Black, margen_izquierdo + 50, margen_superior + 170 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(nombre_detalle, Font_texto_impresion, Brushes.Black, margen_izquierdo + 100, margen_superior + 170 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(numero_tecnico_detalle, Font_texto_impresion, Brushes.Black, margen_izquierdo + 270, margen_superior + 170 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(cantidad_detalle, Font_texto_impresion, Brushes.Black, margen_izquierdo + 500, margen_superior + 170 + (numero_lineas * multiplicador_lineas), format1)
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(precio_detalle, Font_texto_impresion, Brushes.Black, margen_izquierdo + 570, margen_superior + 170 + (numero_lineas * multiplicador_lineas), format1)
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(total_detalle, Font_texto_impresion, Brushes.Black, margen_izquierdo + 640, margen_superior + 170 + (numero_lineas * multiplicador_lineas), format1)
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(fecha_detalle, Font_texto_impresion, Brushes.Black, margen_izquierdo + 660, margen_superior + 170 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(vendedor_detalle, Font_texto_impresion, Brushes.Black, margen_izquierdo + 730, margen_superior + 170 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************
