...
Public Class Form_nuevo_servicio_lubricentro
    ...
    Private Sub btn_grabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_grabar.Click
        ...
        SC.CommandText = "insert into servicios_lubricentro (patente, modelo, codigo_1, filtro_de_aceite, codigo_2, aceite_de_motor, codigo_3, filtro_de_aire, codigo_4, filtro_de_combustible, codigo_5, aceite_de_caja, codigo_6, aceite_diferencial, codigo_7, otros_1, codigo_8, otros_2, codigo_9, otros_3,  codigo_10, otros_4,kilometraje, cantidad_1, cantidad_2, cantidad_3, cantidad_4, cantidad_5, cantidad_6, cantidad_7,cantidad_8, cantidad_9,cantidad_10, rut_mecanico, usuario_responsable, fecha, estado, tipo_documento, nro_documento, hora, comentario) values('" & (Form_ventas_lubricentro.txt_codigo_patente.Text) & "', '" & (txt_modelo.Text) & "', '" & (Form_ventas_lubricentro.txt_codigo_filtro_aceite.Text) & "', '" & (Form_ventas_lubricentro.txt_nombre_filtro_aceite.Text) & "', '" & (Form_ventas_lubricentro.txt_codigo_aceite_motor.Text) & "', '" & (Form_ventas_lubricentro.txt_nombre_aceite_motor.Text) & "', '" & (Form_ventas_lubricentro.txt_codigo_filtro_aire.Text) & "', '" & (Form_ventas_lubricentro.txt_nombre_filtro_aire.Text) & "', '" & (Form_ventas_lubricentro.txt_codigo_aceite_combustible.Text) & "', '" & (Form_ventas_lubricentro.txt_nombre_aceite_combustible.Text) & "', '" & (Form_ventas_lubricentro.txt_codigo_aceite_caja.Text) & "', '" & (Form_ventas_lubricentro.txt_nombre_aceite_caja.Text) & "', '" & (Form_ventas_lubricentro.txt_codigo_aceite_diferencial.Text) & "', '" & (Form_ventas_lubricentro.txt_nombre_aceite_diferencial.Text) & "', '" & (Form_ventas_lubricentro.txt_codigo_otros_1.Text) & "', '" & (Form_ventas_lubricentro.txt_nombre_otros_1.Text) & "', '" & (Form_ventas_lubricentro.txt_codigo_otros_2.Text) & "', '" & (Form_ventas_lubricentro.txt_nombre_otros_2.Text) & "', '" & (Form_ventas_lubricentro.txt_codigo_otros_3.Text) & "', '" & (Form_ventas_lubricentro.txt_nombre_otros_3.Text) & "', '" & (Form_ventas_lubricentro.txt_codigo_otros_4.Text) & "', '" & (Form_ventas_lubricentro.txt_nombre_otros_4.Text) & "','" & (Form_ventas_lubricentro.txt_kilometraje.Text) & "', '" & (Form_ventas_lubricentro.txt_cantidad_1.Text) & "', '" & (Form_ventas_lubricentro.txt_cantidad_2.Text) & "', '" & (Form_ventas_lubricentro.txt_cantidad_3.Text) & "', '" & (Form_ventas_lubricentro.txt_cantidad_4.Text) & "', '" & (Form_ventas_lubricentro.txt_cantidad_5.Text) & "', '" & (Form_ventas_lubricentro.txt_cantidad_6.Text) & "', '" & (Form_ventas_lubricentro.txt_cantidad_7.Text) & "', '" & (Form_ventas_lubricentro.txt_cantidad_8.Text) & "', '" & (Form_ventas_lubricentro.txt_cantidad_9.Text) & "','" & (Form_ventas_lubricentro.txt_cantidad_10.Text) & "', '" & (Form_ventas_lubricentro.txt_rut_vendedor.Text) & "', '" & (miusuario) & "', '" & (Form_menu_principal.dtp_fecha.Text) & "', 'PENDIENTE', '', '', '" & (Form_menu_principal.lbl_hora.Text) & "', '" & (txt_comentario.Text) & "')"
        DA.SelectCommand = SC
        DA.Fill(DT)
