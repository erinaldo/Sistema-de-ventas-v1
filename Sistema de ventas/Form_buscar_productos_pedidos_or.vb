...
Public Class Form_buscar_productos_pedidos_or
    ...
    Private Sub Form_buscar_productos_pedidos_or_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_pedidos_or.Enabled = True
        Form_pedidos_or.WindowState = FormWindowState.Normal
        Form_pedidos_or.txt_codigo.Focus()
    End Sub

    Private Sub Form_buscar_productos_pedidos_or_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_productos_pedidos_or_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
        txt_busqueda.Focus()
    ...
    Private Sub migrilla_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles grilla_buscador_productos_ventas.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Form_pedidos_or.txt_codigo.Text = codigo
            Form_pedidos_or.limpiar_datos_productos()
            Form_pedidos_or.mostrar_cantidad_real()
            Form_pedidos_or.mostrar_nombre_proveedor()
            Form_pedidos_or.txt_cantidad_agregar.Text = ""
            Form_pedidos_or.txt_cantidad_agregar.Focus()
            Me.Close()
        End If
    End Sub
