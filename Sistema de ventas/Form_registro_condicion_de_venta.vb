...
Public Class Form_registro_condicion_de_venta
    Dim VarSeleccion As Integer
    Dim MiPos As Integer

    Private Sub Form_registro_condicion_de_venta_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed

        Form_menu_principal.WindowState = FormWindowState.Maximized

    End Sub

    Private Sub Form_registro_condicion_de_venta_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_registro_condicion_de_venta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub mostrar(ByVal i As Integer)
        Try
            If DS.Tables(DT.TableName).Rows.Count > 0 Then
                txt_nombre_marca.Text = DS.Tables(DT.TableName).Rows(i).Item("nombre")
            End If
        Catch
        End Try
    End Sub
    ...
    Sub actualizar_tabla()
        ...
        SC.CommandText = "select * from condicion_venta where documento = '" & (combo_venta.Text) & "' order by nombre"
        DA.SelectCommand = SC
        DA.Fill(DT)
        DS.Tables.Add(DT)
        conexion.Close()
    ...
    Private Sub btn_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        ...
        If txt_nombre_marca.Text = "" Then mensaje = "CAMPO CONDICION VACIO, FAVOR LLENAR" + Chr(13) & mensaje
        ...
        Else
            If VarSeleccion = 1 Then
                conexion.Close()
                Consultas_SQL("select * from condicion_venta where documento = '" & (combo_venta.Text) & "'")
                If DS.Tables(DT.TableName).Rows.Count > 0 Then
                    ...
                    Exit Sub
                Else
                    SC.CommandText = "INSERT INTO condicion_venta(nombre, documento) VALUES ('" & (txt_nombre_marca.Text) & "', '" & (combo_venta.Text) & "')"
                    DA.SelectCommand = SC
                    DA.Fill(DT)

                    SC.Connection = conexion
                    SC.CommandText = "insert into bitacora_de_cambios (procedencia, detalle, codigo, fecha, TIPO, usuario_responsable) values('CONDICION DE VENTA','CREACION DE CONDICION DE VENTA','" & (txt_nombre_marca.Text) & "','" & (Form_menu_principal.dtp_fecha.Text) & "','CREACION','" & (miusuario) & "')"
                    DA.SelectCommand = SC
                    DA.Fill(DT)
    ...
    Private Sub btn_eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_eliminar.Click
        ...
        If valormensaje = vbYes Then
            SC.Connection = conexion
            SC.CommandText = "delete from condicion_venta where nombre = '" & (txt_nombre_marca.Text) & "' and documento = '" & (combo_venta.Text) & "'"
            DA.SelectCommand = SC
            DA.Fill(DT)
        End If
    ...
    Private Sub txt_nombre_marca_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_nombre_marca.GotFocus
        txt_nombre_marca.BackColor = Color.LightSkyBlue
    End Sub

    Private Sub txt_nombre_marca_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_nombre_marca.KeyPress
    ...
    Private Sub txt_nombre_marca_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_nombre_marca.TextChanged
