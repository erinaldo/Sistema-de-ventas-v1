...
Public Class Form_documentos_con_pagos_combinados
    Dim mifecha2 As String
    Dim mifecha4 As String

    Private Sub Form_documentos_con_pagos_combinados_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_menu_principal.WindowState = FormWindowState.Maximized
    End Sub

    Private Sub Form_documentos_con_pagos_combinados_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
        ...
        End If
    End Sub
    Private Sub Form_documentos_con_pagos_combinados_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        fecha()
        mostrar_malla()
    ...
    Sub mostrar_malla()
        ...
        If combo_venta.Text = "BOLETA" Then
            ...
            conexion.Open()
            SC3.Connection = conexion
            SC3.CommandText = "select nro_doc as NUMERO, tipo_doc as 'TIPO', FECHA, VALOR, CONDICION_DE_PAGO AS 'CONDICION DE PAGO' from detalle_condicion_de_pago where fecha >='" & (mifecha2) & "' and fecha <= '" & (mifecha4) & "' and tipo_doc ='BOLETA'"
            DA3.SelectCommand = SC3
            DA3.Fill(DT3)
            DS3.Tables.Add(DT3)
            grilla_documento.DataSource = DS3.Tables(DT3.TableName)
        ...
        If combo_venta.Text = "FACTURA" Then
            ...
            conexion.Open()
            SC3.Connection = conexion
            SC3.CommandText = "select nro_doc as NUMERO, tipo_doc as 'TIPO',  FECHA, VALOR, CONDICION_DE_PAGO AS 'CONDICION DE PAGO' from detalle_condicion_de_pago where  fecha >='" & (mifecha2) & "' and fecha <= '" & (mifecha4) & "' and tipo_doc ='FACTURA'"
            DA3.SelectCommand = SC3
            DA3.Fill(DT3)
            DS3.Tables.Add(DT3)
            grilla_documento.DataSource = DS3.Tables(DT3.TableName)
        ...
        If combo_venta.Text = "GUIA" Then
            ...
            conexion.Open()
            SC3.Connection = conexion
            SC3.CommandText = "select nro_doc as NUMERO, tipo_doc as 'TIPO', FECHA, VALOR, CONDICION_DE_PAGO AS 'CONDICION DE PAGO' from detalle_condicion_de_pago where  fecha >='" & (mifecha2) & "' and fecha <= '" & (mifecha4) & "' and tipo_doc ='GUIA'"
            DA3.SelectCommand = SC3
            DA3.Fill(DT3)
            DS3.Tables.Add(DT3)
            grilla_documento.DataSource = DS3.Tables(DT3.TableName)
