...
Public Class Form_detalle_ventas
    ...
    Sub mostrar_malla()
        ...
        If combo_venta.Text = "GUIA" Then
            ...
            If Combo_condicion.Text = "-" Then
                SC3.CommandText = "select guia.tipo as tipo, guia.N_guia as 'NRO.', usuarios.nombre_usuario NOMBRE, guia.sUBtotal AS SUBTOTAL , guia.DESCUENTO AS 'DESC.' , guia.total AS TOTAL, guia.FECHA_VENTA AS 'FECHA', HORA AS HORA, guia.CONDICIONES AS 'CONDICION', guia.rut_cliente AS RUT, NOMBRE_CLIENTE AS 'CLIENTE' from guia , usuarios, clientes where fecha_venta >='" & (mifecha2) & "' and fecha_venta <= '" & (mifecha4) & "' AND tipo LIKE 'guia%' AND usuarios.rut_usuario =guia.usuario_responsable AND guia.rut_cliente=clientes.rut_cliente GROUP BY N_guia ORDER BY N_guia"
                consulta = consulta
            End If

            If Combo_condicion.Text = "CREDITO" Then
                SC3.CommandText = "select guia.tipo as tipo, guia.N_guia as 'NRO.', usuarios.nombre_usuario NOMBRE, guia.sUBtotal AS SUBTOTAL , guia.DESCUENTO AS 'DESC.' , guia.total AS TOTAL, guia.FECHA_VENTA AS 'FECHA', HORA AS HORA, guia.CONDICIONES AS 'CONDICION', guia.rut_cliente AS RUT, NOMBRE_CLIENTE AS 'CLIENTE' from guia , usuarios, clientes where fecha_venta >='" & (mifecha2) & "' and fecha_venta <= '" & (mifecha4) & "' AND tipo LIKE 'guia%' AND usuarios.rut_usuario =guia.usuario_responsable AND guia.rut_cliente=clientes.rut_cliente  AND guia.CONDICIONES='CREDITO' GROUP BY N_guia ORDER BY N_guia"
        ...
        If combo_venta.Text = "COTIZACION" Then
            ...
            If Combo_condicion.Text = "CREDITO" Then
                SC3.CommandText = "select COTIZACION.tipo as tipo, COTIZACION.N_COTIZACION as 'NRO.', usuarios.nombre_usuario NOMBRE, COTIZACION.sUBtotal AS SUBTOTAL , COTIZACION.DESCUENTO AS 'DESC.' , COTIZACION.total AS TOTAL, COTIZACION.FECHA_VENTA AS 'FECHA', HORA AS HORA, COTIZACION.CONDICIONES AS 'CONDICION', COTIZACION.rut_cliente AS RUT, NOMBRE_CLIENTE AS 'CLIENTE' from COTIZACION , usuarios, clientes where fecha_venta >='" & (mifecha2) & "' and fecha_venta <= '" & (mifecha4) & "' AND tipo LIKE 'COTIZACION%' AND usuarios.rut_usuario =COTIZACION.usuario_responsable AND COTIZACION.rut_cliente=clientes.rut_cliente AND COTIZACION.CONDICIONES='CREDITO' GROUP BY N_COTIZACION ORDER BY N_COTIZACION"
        ...
        If combo_venta.Text = "NOTA DE CREDITO" Then
            ...
            If Combo_condicion.Text = "-" Then
                SC3.CommandText = "select nota_credito.tipo as tipo, nota_credito.N_nota_credito as 'NRO.', usuarios.nombre_usuario NOMBRE, nota_credito.sUBtotal AS SUBTOTAL , nota_credito.DESCUENTO AS 'DESC.' , nota_credito.total AS TOTAL, nota_credito.FECHA_VENTA AS 'FECHA', HORA AS HORA, nota_credito.CONDICIONES AS 'CONDICION', nota_credito.rut_cliente AS RUT, NOMBRE_CLIENTE AS 'CLIENTE', MOTIVO AS 'MOTIVO' from nota_credito , usuarios, clientes where fecha_venta >='" & (mifecha2) & "' and fecha_venta <= '" & (mifecha4) & "' AND tipo LIKE 'NOTA DE CREDITO%' AND usuarios.rut_usuario =nota_credito.usuario_responsable AND nota_credito.rut_cliente=clientes.rut_cliente GROUP BY N_nota_credito ORDER BY N_nota_credito"
                consulta = consulta
            End If

            If Combo_condicion.Text = "CREDITO" Then
                SC3.CommandText = "select nota_credito.tipo as tipo, nota_credito.N_nota_credito as 'NRO.', usuarios.nombre_usuario NOMBRE, nota_credito.sUBtotal AS SUBTOTAL , nota_credito.DESCUENTO AS 'DESC.' , nota_credito.total AS TOTAL, nota_credito.FECHA_VENTA AS 'FECHA', HORA AS HORA, nota_credito.CONDICIONES AS 'CONDICION', nota_credito.rut_cliente AS RUT, NOMBRE_CLIENTE AS 'CLIENTE', MOTIVO AS 'MOTIVO' from nota_credito , usuarios, clientes where fecha_venta >='" & (mifecha2) & "' and fecha_venta <= '" & (mifecha4) & "' AND tipo LIKE 'NOTA DE CREDITO%' AND usuarios.rut_usuario =nota_credito.usuario_responsable AND nota_credito.rut_cliente=clientes.rut_cliente  AND nota_credito.CONDICIONES='CREDITO'  GROUP BY N_nota_credito ORDER BY N_nota_credito"
        ...
        If combo_venta.Text = "NOTA DE DEBITO" Then
            ...
            If Combo_condicion.Text = "-" Then
                SC3.CommandText = "select nota_debito.tipo as tipo, nota_debito.N_nota_debito as 'NRO.', usuarios.nombre_usuario NOMBRE, nota_debito.sUBtotal AS SUBTOTAL , nota_debito.DESCUENTO AS 'DESC.' , nota_debito.total AS TOTAL, nota_debito.FECHA_VENTA AS 'FECHA', HORA AS HORA, nota_debito.CONDICIONES AS 'CONDICION', nota_debito.rut_cliente AS RUT, NOMBRE_CLIENTE AS 'CLIENTE' from nota_debito , usuarios, clientes where fecha_venta >='" & (mifecha2) & "' and fecha_venta <= '" & (mifecha4) & "' AND tipo LIKE 'NOTA DE DEBITO%' AND usuarios.rut_usuario =nota_debito.usuario_responsable AND nota_debito.rut_cliente=clientes.rut_cliente GROUP BY N_nota_debito ORDER BY N_nota_debito"
                consulta = consulta
            End If

            If Combo_condicion.Text = "CREDITO" Then
                SC3.CommandText = "select nota_debito.tipo as tipo, nota_debito.N_nota_debito as 'NRO.', usuarios.nombre_usuario NOMBRE, nota_debito.sUBtotal AS SUBTOTAL , nota_debito.DESCUENTO AS 'DESC.' , nota_debito.total AS TOTAL, nota_debito.FECHA_VENTA AS 'FECHA', HORA AS HORA, nota_debito.CONDICIONES AS 'CONDICION', nota_debito.rut_cliente AS RUT, NOMBRE_CLIENTE AS 'CLIENTE' from nota_debito , usuarios, clientes where fecha_venta >='" & (mifecha2) & "' and fecha_venta <= '" & (mifecha4) & "' AND tipo LIKE 'NOTA DE DEBITO%' AND usuarios.rut_usuario =nota_debito.usuario_responsable AND nota_debito.rut_cliente=clientes.rut_cliente AND nota_debito.CONDICIONES='CREDITO'  GROUP BY N_nota_debito ORDER BY N_nota_debito"
    ...
    Private Sub btn_imprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_imprimir.Click
        ...
        '    Dim rpt As New Crystal_detalle_ventas
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("TIPO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 50, margen_superior + 120)
        e.Graphics.DrawString("NRO. DOC.", Font_titulo_columna, Brushes.Black, margen_izquierdo + 120, margen_superior + 120)
        e.Graphics.DrawString("USUARIO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 190, margen_superior + 120)
        e.Graphics.DrawString("SUBTOTAL", Font_titulo_columna, Brushes.Black, margen_izquierdo + 340, margen_superior + 120)
        e.Graphics.DrawString("DESCUENTO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 420, margen_superior + 120)
        e.Graphics.DrawString("TOTAL", Font_titulo_columna, Brushes.Black, margen_izquierdo + 500, margen_superior + 120)
        e.Graphics.DrawString("FECHA", Font_titulo_columna, Brushes.Black, margen_izquierdo + 580, margen_superior + 120)
        e.Graphics.DrawString("HORA", Font_titulo_columna, Brushes.Black, margen_izquierdo + 660, margen_superior + 120)
        e.Graphics.DrawString("CONDICION", Font_titulo_columna, Brushes.Black, margen_izquierdo + 730, margen_superior + 120)
        e.Graphics.DrawString("RUT", Font_titulo_columna, Brushes.Black, margen_izquierdo + 840, margen_superior + 120)
        e.Graphics.DrawString("NOMBRE", Font_titulo_columna, Brushes.Black, margen_izquierdo + 920, margen_superior + 120)

        e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 40, margen_superior + 135, margen_izquierdo + 1120, margen_superior + 135)
        ...
        For i = numero_lineas_total To grilla_documento.Rows.Count - 1
            ...
            e.Graphics.DrawString(Vartipo, Font_texto_impresion, Brushes.Black, margen_izquierdo + 50, margen_superior + 140 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarNro, Font_texto_impresion, Brushes.Black, margen_izquierdo + 120, margen_superior + 140 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarUsuario, Font_texto_impresion, Brushes.Black, margen_izquierdo + 190, margen_superior + 140 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarSubtotal, Font_texto_impresion, Brushes.Black, margen_izquierdo + 400, margen_superior + 140 + (numero_lineas * multiplicador_lineas), format1)
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarDescuento, Font_texto_impresion, Brushes.Black, margen_izquierdo + 480, margen_superior + 140 + (numero_lineas * multiplicador_lineas), format1)
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarTotal, Font_texto_impresion, Brushes.Black, margen_izquierdo + 560, margen_superior + 140 + (numero_lineas * multiplicador_lineas), format1)
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarFecha, Font_texto_impresion, Brushes.Black, margen_izquierdo + 580, margen_superior + 140 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarHora, Font_texto_impresion, Brushes.Black, margen_izquierdo + 660, margen_superior + 140 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarCondicion, Font_texto_impresion, Brushes.Black, margen_izquierdo + 730, margen_superior + 140 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarRut, Font_texto_impresion, Brushes.Black, margen_izquierdo + 840, margen_superior + 140 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(VarNombre, Font_texto_impresion, Brushes.Black, margen_izquierdo + 920, margen_superior + 140 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************
            ...
            If numero_lineas > 62 Then
                'Linea horizontal
                e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 40, margen_superior + 145 + (numero_lineas * multiplicador_lineas), margen_izquierdo + 1120, margen_superior + 145 + (numero_lineas * multiplicador_lineas))
                '***************************************************************************************************************************************************
        ...
        e.Graphics.DrawString("TOTALES:             " & txt_subtotal_millar.Text, Font_texto_impresion, Brushes.Black, margen_izquierdo + 400, margen_superior + 147 + (numero_lineas * multiplicador_lineas), format1)
        '***************************************************************************************************************************************************

        e.Graphics.DrawString(txt_descuento_millar.Text, Font_texto_impresion, Brushes.Black, margen_izquierdo + 480, margen_superior + 147 + (numero_lineas * multiplicador_lineas), format1)
        '***************************************************************************************************************************************************

        e.Graphics.DrawString(txt_total_millar.Text, Font_texto_impresion, Brushes.Black, margen_izquierdo + 560, margen_superior + 147 + (numero_lineas * multiplicador_lineas), format1)
        '***************************************************************************************************************************************************
