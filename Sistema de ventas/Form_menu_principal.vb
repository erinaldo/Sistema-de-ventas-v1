...
Public Class Form_menu_principal
    ...
    Dim actualizar_reloj As Integer = 60
    Dim contador As Integer = 58
    ...
    Sub cargar_iconos_menu()
        'Try
        '    'ADQUISICIONESToolStripMenuItem.Image = Image.FromFile("C:\Sistema de ventas\Sucursales\" & form_Ingreso.combo_conexion.Text & "\Iconos sistema\Adquisiciones.png")
        ...
        'Try
        '    ' ADMINISTRACIONToolStripMenuItem.Image = Image.FromFile("C:\Sistema de ventas\Sucursales\" & form_Ingreso.combo_conexion.Text & "\Iconos sistema\administracion.png")
        ...
        'Try
        '    'BODEGAToolStripMenuItem.Image = Image.FromFile("C:\Sistema de ventas\Sucursales\" & form_Ingreso.combo_conexion.Text & "\Iconos sistema\bodega.png")
        ...
        'Try
        '    'CONFIGURACIONToolStripMenuItem.Image = Image.FromFile("C:\Sistema de ventas\Sucursales\" & form_Ingreso.combo_conexion.Text & "\Iconos sistema\configuracion.png")
        ...
        'Try
        '    'MANTENEDORESToolStripMenuItem.Image = Image.FromFile("C:\Sistema de ventas\Sucursales\" & form_Ingreso.combo_conexion.Text & "\Iconos sistema\Mantenedores.png")
        ...
        'Try
        '    'VENTASToolStripMenuItem.Image = Image.FromFile("C:\Sistema de ventas\Sucursales\" & form_Ingreso.combo_conexion.Text & "\Iconos sistema\ventas.png")
    ...
    Sub personalizar_empresa()
        ...
        If mirutempresa = "76313245-5" Then
            MenuStrip1.ForeColor = Color.White
            MenuStrip1.BackColor = Color.FromArgb(69, 168, 142)
            lbl_fecha.ForeColor = Color.FromArgb(69, 168, 142)
            lbl_hora.ForeColor = Color.FromArgb(69, 168, 142)
            lbl_version.ForeColor = Color.FromArgb(69, 168, 142)
            lbl_mensaje.ForeColor = Color.FromArgb(69, 168, 142)
            lbl_soporte_remoto.ForeColor = Color.FromArgb(69, 168, 142)
            lbl_uc.ForeColor = Color.FromArgb(69, 168, 142)
            lbl_usuario_conectado.ForeColor = Color.FromArgb(69, 168, 142)
            Panel_pie.BackColor = Color.FromArgb(69, 168, 142)
            lbl_pie.ForeColor = Color.FromArgb(33, 36, 59)
            lbl_contacto.ForeColor = Color.White
        End If
    ...
    Sub ajustar()
        ...
        lbl_soporte_remoto.Location = New Point(Me.Width - lbl_soporte_remoto.Width - 30, 100)
        lbl_uc.Location = New Point(Me.Width - lbl_uc.Width - 30, 120)
        lbl_usuario_conectado.Location = New Point(Me.Width - lbl_usuario_conectado.Width - 30, 140)
        lbl_fecha.Location = New Point(Me.Width - lbl_fecha.Width - 30, 160)
        lbl_hora.Location = New Point(Me.Width - lbl_hora.Width - 30, 180)
        tamaño_menu = MenuStrip1.Width / 6
        ...
        MENU_VENTAS_ToolStripMenuItem.Width = Int(tamaño_menu)
        MenuStrip1.Height = 75
        Panel_pie.Width = Me.Width
        Panel_pie.Height = 100
    ...
    Sub cargar_logo()
        Try
            ...
            If DS.Tables(DT.TableName).Rows.Count > 0 Then
                ...
                While lector.Read
                    ...
                    Imagen_reporte = lector("logo_empresa_reportes")
        ...
        'PictureBox_logo.Image = webDownloadImage("https://www.arana.cl/repuestos%20arana/menu.png", True, "C:\menu.jpg")
    End Sub
    ...
    Private Sub form_Menu_admin_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
        ...
        If mirutempresa = "76313245-5" Then
            Me.BackColor = Color.FromArgb(33, 36, 59)
            Exit Sub
        End If
    ...
    Private Sub VALORESToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles VALORES_DE_SISTEMA_ToolStripMenuItem.Click
        lbl_mensaje.Visible = True
        Me.Enabled = False
    ...
    Private Sub Timer_hora_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer_hora.Tick
        If contador < actualizar_reloj Then
            contador = contador + 1
        Else
            fecha_hora_servidor()
            lbl_fecha.Location = New Point(Me.Width - lbl_fecha.Width - 30, 160)
    ...
    Private Sub HISTORIALDECUENTAToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        lbl_mensaje.Visible = True
        Me.Enabled = False
        Form_historial_de_cuenta.Show()
        Form_historial_de_cuenta.WindowState = FormWindowState.Normal
        Me.WindowState = FormWindowState.Minimized
        lbl_mensaje.Visible = False
        Me.Enabled = True
    End Sub
    ...
    Private Sub CLIENTESToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DEUDA_CLIENTES_ToolStripMenuItem.Click
        lbl_mensaje.Visible = True
        Me.Enabled = False
        Form_deuda_cliente.Show()
        Form_deuda_cliente.WindowState = FormWindowState.Normal
        Me.WindowState = FormWindowState.Minimized
        lbl_mensaje.Visible = False
        Me.Enabled = True
    End Sub
    ...
    Private Sub PEDIDOSORToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PEDIDOS_OR_ToolStripMenuItem.Click
        lbl_mensaje.Visible = True
        Me.Enabled = False
        Form_pedidos_or.Show()
        Form_pedidos_or.WindowState = FormWindowState.Normal
        Me.WindowState = FormWindowState.Minimized
        lbl_mensaje.Visible = False
        Me.Enabled = True
    End Sub
    ...
    Private Sub INVENTARIODIARIOToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles INVENTARIO_DIARIO_ToolStripMenuItem.Click
        lbl_mensaje.Visible = True
        Me.Enabled = False
    ...
    Private Sub DocImprimir_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        Dim rect_link_red As New Rectangle(margen_izquierdo + 10, margen_superior + 395, margen_izquierdo + 270, margen_superior + 15)
    ...
    Private Sub FffffToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FffffToolStripMenuItem.Click
        lbl_mensaje.Visible = True
        Me.Enabled = False
        Form_recepcion_de_trabajo.Show()
        Form_recepcion_de_trabajo.WindowState = FormWindowState.Normal
    ...
    Private Sub btn_mostrar_Click(sender As Object, e As EventArgs) Handles btn_mostrar.Click
        PictureBox_logo.Image.Save("C:\Users\claud\Desktop\military\Logo nenu.png", Drawing.Imaging.ImageFormat.Png)
        PictureBox_logo.Image.Save("C:\Users\claud\Desktop\military\Logo nenu.png", Drawing.Imaging.ImageFormat.Png)

        MENU_ADQUISICIONES_ToolStripMenuItem.Image.Save("C:\Users\claud\Desktop\military\Icono-adquisiciones.png", Drawing.Imaging.ImageFormat.Png)
        MENU_ADMINISTRACION_ToolStripMenuItem.Image.Save("C:\Users\claud\Desktop\military\Icono-admiistracion.png", Drawing.Imaging.ImageFormat.Png)
        MENU_BODEGA_ToolStripMenuItem.Image.Save("C:\Users\claud\Desktop\military\Icono-bodega.png", Drawing.Imaging.ImageFormat.Png)
        MENU_CONFIGURACION_ToolStripMenuItem.Image.Save("C:\Users\claud\Desktop\military\Icono-configuracion.png", Drawing.Imaging.ImageFormat.Png)
        MENU_MANTENEDORES_ToolStripMenuItem.Image.Save("C:\Users\claud\Desktop\military\Icono-mantenedores.png", Drawing.Imaging.ImageFormat.Png)
        MENU_VENTAS_ToolStripMenuItem.Image.Save("C:\Users\claud\Desktop\military\Icono-ventas.png", Drawing.Imaging.ImageFormat.Png)
    End Sub
End Class
