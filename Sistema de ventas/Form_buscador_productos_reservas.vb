...
Public Class Form_buscador_productos_reservas
    ...
    Private Sub Form_buscar_productos_reservas_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        Form_reservas.Enabled = True
        Form_reservas.WindowState = FormWindowState.Normal
        Form_reservas.txt_codigo.Focus()
    End Sub

    Private Sub Form_buscar_productos_reservas_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
    ...
    Private Sub Form_buscar_productos_reservas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()

        'Timer_inactividad_buscar_productos_reserva.Start()
    ...
    Private Sub migrilla_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles grilla_buscador_productos_ventas.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Form_reservas.txt_codigo.Text = codigo
            Form_reservas.limpiar_producto()
            Form_reservas.mostrar_datos_productos()
            Form_reservas.mostrar_nombre_proveedor()
            Form_reservas.txt_cantidad_agregar.Text = ""
            Form_reservas.txt_cantidad_agregar.Focus()
            Me.Close()
        End If
    End Sub
    ...
    '    txt_busqueda.BackColor = Color.PaleGreen
    'End Sub
    ...
    Private Sub Timer_inactividad_buscar_productos_reserva_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs)
