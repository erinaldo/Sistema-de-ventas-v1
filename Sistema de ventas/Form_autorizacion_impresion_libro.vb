...
Public Class Form_autorizacion_impresion_libro

    Private Sub Form_autorizacion_impresion_libro_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_libro_de_ventas.WindowState = FormWindowState.Normal
        Form_libro_de_ventas.lbl_mensaje.Visible = False
        Form_libro_de_ventas.Enabled = True

    End Sub

    Private Sub Form_autorizacion_impresion_libro_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_autorizacion_impresion_libro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        ...
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
            ...
            Dim mes_libro As String
            Dim año_libro As String

            mes_libro = Form_menu_principal.dtp_fecha.Value.Month
            año_libro = Form_menu_principal.dtp_fecha.Value.Year

            SC.Connection = conexion
            SC.CommandText = "UPDATE impresion_libro_boletas SET fecha_impresion='" & (Form_menu_principal.dtp_fecha.Text) & "', hora_impresion='" & (Form_menu_principal.lbl_hora.Text) & "',usuario_responsable='" & (miusuario) & "' WHERE  Month(fecha_impresion) ='" & (mes_libro) & "' AND Year(fecha_impresion) ='" & (año_libro) & "'"
            DA.SelectCommand = SC
            DA.Fill(DT)
