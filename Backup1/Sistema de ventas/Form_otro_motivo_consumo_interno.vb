...
Public Class Form_otro_motivo_consumo_interno

    Private Sub Form_otro_motivo_consumo_interno_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        If txt_medio_pago.Text = "" Then
            Form_consumo_interno.Combo_motivo.SelectedItem = "-"
        End If
    ...
    Private Sub Form_otro_motivo_consumo_interno_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_otro_motivo_consumo_interno_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    End Sub
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        ...
        If txt_medio_pago.Text.Contains("CREDITO") Then
            MsgBox("EL MEDIO DE PAGO NO PUEDE SER CREDITO", MessageBoxIcon.Information + MsgBoxStyle.OkOnly, "ATENCION")
            txt_medio_pago.Focus()
            Exit Sub
        End If

        Form_consumo_interno.Combo_motivo.Items.Add(txt_medio_pago.Text)
        Form_consumo_interno.Combo_motivo.SelectedItem = txt_medio_pago.Text
        Me.Close()
    End Sub
