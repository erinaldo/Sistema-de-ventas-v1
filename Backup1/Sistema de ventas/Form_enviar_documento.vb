    ...
    Sub grabar_detalle_factura()
        ...
        For i = 0 To grilla_detalle.Rows.Count - 1
            If grilla_detalle.Rows(i).Cells(19).Value = True Then
                ...
                Form_envio_productos_sucursal.recuperar_conexion()
    ...
    Private Sub DocImprimir_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        For i = 0 To grilla_detalle.Rows.Count - 1
            If grilla_detalle.Rows(i).Cells(19).Value = True Then
                ...
                e.Graphics.DrawString(Varcantidad, Font_texto_detalle, Brushes.Black, margen_izquierdo + 280, margen_superior + 385 + (i * multiplicador_lineas), format1)
        ...
        e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 1, margen_superior + numero_lineas + 500, margen_izquierdo + 295, margen_superior + numero_lineas + 500)

        Dim rect_firma As New Rectangle(margen_izquierdo + 10, margen_superior + numero_lineas + 510, margen_izquierdo + 270, margen_superior + numero_lineas + 15)
        e.Graphics.DrawString("FIRMA RESPONSABLE", Font_texto_titulo_detalle, Brushes.Black, rect_firma, stringFormat)




        Dim rect_guion_final As New Rectangle(margen_izquierdo + 10, margen_superior + numero_lineas + 550, margen_izquierdo + 270, margen_superior + numero_lineas + 15)
