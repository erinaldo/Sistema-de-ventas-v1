...
Public Class Form_detalle_cuadratura_caja
    ...
    Private Sub Form_ingresos_cuadratura_caja_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If mirutempresa <> "87686300-6" Then
            ...
            combo_tipo.Items.Add("SUELDO SIN IMPUTAR")
            combo_tipo.SelectedItem = "-"

            Dim fecha_actual As String
            fecha_actual = Form_menu_principal.dtp_fecha.Value.Day

            'If Val(fecha_actual) >= "1" And Val(fecha_actual) <= "10" Then
            'combo_tipo.Items.Add("SUELDO")
            'End If

            'If Val(fecha_actual) >= "11" And Val(fecha_actual) <= "19" Then
            'combo_tipo.Items.Add("ANTICIPO")
            'End If

            'If Val(fecha_actual) >= "20" And Val(fecha_actual) <= "31" Then
            'combo_tipo.Items.Add("SUELDO")

            'combo_tipo.Items.Add("AGUINALDO")
            'End If
        End If
    ...
    Private Sub btn_agregar_entrada_remuneracion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_agregar_entrada_remuneracion.Click
        ...
        If combo_tipo.Text = "EGRESO" Then
            txt_monto.Text = "-" & txt_monto.Text
        End If

        If combo_tipo.Text = "RETIRO" Then
            txt_monto.Text = "-" & txt_monto.Text
        End If
        ...
        If combo_tipo.Text = "EGRESOS CON BOLETA Y OTROS" Then
            txt_monto.Text = "-" & txt_monto.Text
        End If

        If combo_tipo.Text = "EGRESOS CON FACTURA" Then
            txt_monto.Text = "-" & txt_monto.Text
        End If

        If combo_tipo.Text = "EGRESOS CON FACTURA (EXISTENCIAS)" Then
            txt_monto.Text = "-" & txt_monto.Text
        End If

        If combo_tipo.Text = "EGRESOS CON FACTURA (OTROS)" Then
            txt_monto.Text = "-" & txt_monto.Text
        End If

        If combo_tipo.Text = "VENTAS PENDIENTES" Then
            txt_monto.Text = "-" & txt_monto.Text
        End If
        ...
        If combo_tipo.Text = "EGRESO CON BOLETA" Then
            txt_monto.Text = "-" & txt_monto.Text
        End If

        If combo_tipo.Text = "EGRESO CON FACTURA" Then
            txt_monto.Text = "-" & txt_monto.Text
        End If

        If combo_tipo.Text = "OTRO EGRESO" Then
            txt_monto.Text = "-" & txt_monto.Text
        End If
        ...
        If combo_tipo.Text.Contains("SUELDO") Then
            If txt_monto.Text.Contains("-") Then
            Else
                txt_monto.Text = "-" & txt_monto.Text
            End If
        End If
        If combo_tipo.Text.Contains("ANTICIPO") Then
            If txt_monto.Text.Contains("-") Then
            Else
                txt_monto.Text = "-" & txt_monto.Text
            End If
        End If
        If combo_tipo.Text.Contains("EGRESO") Then
            If txt_monto.Text.Contains("-") Then
            Else
                txt_monto.Text = "-" & txt_monto.Text
            End If
        ...
        If combo_tipo.Text.Contains("RETIRO") Then
            If txt_monto.Text.Contains("-") Then
            Else
                txt_monto.Text = "-" & txt_monto.Text
            End If
        ...
        If combo_tipo.Text = "SUELDO SIN IMPUTAR" Then
            ...
            SC.Connection = conexion
            SC.CommandText = "insert into detalle_fondo_sueldos (detalle, monto, fecha, tipo, usuario_responsable, hora) values ('" & (Combo_detalle.Text) & "' , '" & (txt_monto.Text) & "', '" & (mifecha2) & "','" & (combo_tipo.Text) & "','" & (miusuario) & "','" & (Form_menu_principal.lbl_hora.Text) & "')"
            DA.SelectCommand = SC
            DA.Fill(DT)
        End If
    ...
    Sub cargar_detalle()
        ...
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
            ...
            For i = 0 To DS.Tables(DT.TableName).Rows.Count - 1
                ...
                grilla_detalle_cuadratura.Rows.Add(DS.Tables(DT.TableName).Rows(i).Item("detalle"), _
    ...
    Private Sub DocImprimir_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        e.Graphics.DrawString("MONTO", Font_texto_cabecera, Brushes.Black, margen_izquierdo + 0, margen_superior + 305)
        e.Graphics.DrawString(":", Font_texto_cabecera, Brushes.Black, margen_izquierdo + 75, margen_superior + 305)
        e.Graphics.DrawString("$" & monto_final, Font_texto_cabecera, Brushes.Black, margen_izquierdo + 85, margen_superior + 305)
        ...
        If tipo_anticipo = "ORIGINAL" Then
            e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 1, margen_superior + 450, margen_izquierdo + 295, margen_superior + 450)
