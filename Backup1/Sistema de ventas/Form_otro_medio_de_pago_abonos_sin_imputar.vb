...
Public Class Form_otro_medio_de_pago_abonos_sin_imputar

    Private Sub Form_otro_medio_de_pago_abonos_sin_imputar_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        If txt_medio_pago.Text = "" Then
            Form_agregar_abonos_sin_imputar.combo_condiciones.SelectedItem = "-"
        End If
        Form_agregar_abonos_sin_imputar.WindowState = FormWindowState.Normal
        Form_agregar_abonos_sin_imputar.Enabled = True
    End Sub

    Private Sub Form_otro_medio_de_pago_abonos_sin_imputar_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_otro_medio_de_pago_abonos_sin_imputar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    End Sub
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        ...
        Form_agregar_abonos_sin_imputar.combo_condiciones.Items.Add(txt_medio_pago.Text)
        Form_agregar_abonos_sin_imputar.combo_condiciones.SelectedItem = txt_medio_pago.Text
        Me.Close()
    End Sub
