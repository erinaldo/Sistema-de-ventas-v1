Public Class Form_detalle_sin_documentos
    Dim mifecha2 As String
    Dim mifecha4 As String
    Dim NroDocKardex As String
    Dim TipoDocKardex As String
    Dim Rut_proveedor As String
    Private Sub Form_detalle_sin_documentos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_menu_principal.WindowState = FormWindowState.Maximized
    End Sub

    Private Sub Form_detalle_sin_documentos_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_detalle_sin_documentos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Sub mostrar_documentos()
        ...
        If combo_venta.Text = "COMPRA" Then
            ...
            SC.CommandText = "select * from detalle_compra group by n_compra, rut_proveedor order by n_compra asc"
            DA.SelectCommand = SC
            DA.Fill(DT)
            DS.Tables.Add(DT)
        ...
        If combo_venta.Text = "BOLETA" Then
            ...
            DS.Clear()
            SC.Connection = conexion
            SC.CommandText = "select * from detalle_boleta group by n_boleta order by n_boleta asc"
            DA.SelectCommand = SC
            DA.Fill(DT)
            DS.Tables.Add(DT)
            If DS.Tables(DT.TableName).Rows.Count > 0 Then
        ...
        If combo_venta.Text = "GUIA" Then
            ...
            DS.Clear()
            SC.Connection = conexion
            SC.CommandText = "select * from detalle_guia group by n_guia order by n_guia asc"
            DA.SelectCommand = SC
            DA.Fill(DT)
            DS.Tables.Add(DT)
            If DS.Tables(DT.TableName).Rows.Count > 0 Then
        ...
        If combo_venta.Text = "FACTURA" Then
            ...
            DS.Clear()
            SC.Connection = conexion
            SC.CommandText = "select * from detalle_factura group by n_factura order by n_factura asc"
            DA.SelectCommand = SC
            DA.Fill(DT)
            DS.Tables.Add(DT)
            If DS.Tables(DT.TableName).Rows.Count > 0 Then
        ...
        If combo_venta.Text = "NOTA DE CREDITO" Then
            ...
            DS.Clear()
            SC.Connection = conexion
            SC.CommandText = "select * from detalle_nota_credito group by n_nota_credito order by n_nota_credito asc"
            DA.SelectCommand = SC
            DA.Fill(DT)
            DS.Tables.Add(DT)
            If DS.Tables(DT.TableName).Rows.Count > 0 Then
        ...
        If combo_venta.Text = "NOTA DE DEBITO" Then
            ...
            DS.Clear()
            SC.Connection = conexion
            SC.CommandText = "select * from detalle_nota_debito group by n_nota_debito order by n_nota_debito asc"
            DA.SelectCommand = SC
            DA.Fill(DT)
            DS.Tables.Add(DT)
            If DS.Tables(DT.TableName).Rows.Count > 0 Then
    ...
    Sub revisar_documentos()
        ...
        For i = 0 To grilla_documentos.Rows.Count - 1
            ...
            responsable_doc = grilla_documentos.Rows(i).Cells(2).Value.ToString

            If combo_venta.Text = "COMPRA" Then
                conexion.Close()
                Consultas_SQL("select * from compra where n_compra = '" & (numero) & "' and rut_proveedor = '" & (responsable_doc) & "'")
                If DS.Tables(DT.TableName).Rows.Count > 0 Then
                ...
                Else
                    ...
                    'DA.SelectCommand = SC
                    'DA.Fill(DT)
                    grilla_documentos_sin_detalle.Rows.Add(tipo, numero, responsable_doc)
                End If
            End If

            If combo_venta.Text = "BOLETA" Then
                conexion.Close()
                Consultas_SQL("select * from boleta where n_boleta = '" & (numero) & "'")
                If DS.Tables(DT.TableName).Rows.Count > 0 Then
                ...
                Else
                    ...
                    grilla_documentos_sin_detalle.Rows.Add(tipo, numero, "")
                End If
            End If

            If combo_venta.Text = "FACTURA" Then
                conexion.Close()
                Consultas_SQL("select * from factura where n_factura = '" & (numero) & "'")
                If DS.Tables(DT.TableName).Rows.Count > 0 Then
            ...
            If combo_venta.Text = "GUIA" Then
                conexion.Close()
                Consultas_SQL("select * from guia where n_guia = '" & (numero) & "'")
                If DS.Tables(DT.TableName).Rows.Count > 0 Then
            ...
            If combo_venta.Text = "NOTA DE CREDITO" Then
                conexion.Close()
                Consultas_SQL("select * from nota_credito where n_nota_credito = '" & (numero) & "'")
                If DS.Tables(DT.TableName).Rows.Count > 0 Then
            ...
            If combo_venta.Text = "NOTA DE DEBITO" Then
                conexion.Close()
                Consultas_SQL("select * from nota_debito where n_nota_debito = '" & (numero) & "'")
                If DS.Tables(DT.TableName).Rows.Count > 0 Then
