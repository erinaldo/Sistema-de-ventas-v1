...
Public Class Form_registro_subfamilia_2
    Dim VarSeleccion As Integer
    Dim MiPos As Integer
    Private Sub Form_registro_subfamilia_2_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_menu_principal.WindowState = FormWindowState.Maximized
    End Sub

    Private Sub Form_registro_subfamilia_2_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_registro_subfamilia_2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_guardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        ...
        If VarSeleccion = 1 Then
            conexion.Close()
            Consultas_SQL("select * from subfamilia where CODIGO_FAMILIA = '" & (txt_codigo_familia.Text) & "' AND  nombre_SUBfamilia = '" & (txt_nombre_subfamilia_dos.Text) & "' ")
            If DS.Tables(DT.TableName).Rows.Count > 0 Then
            ...
            Else
                ...
                SC.Connection = conexion
                SC.CommandText = "INSERT INTO subfamilia_dos(cod_auto, codigo_subfamilia, nombre_subfamilia, fecha_modificacion) VALUES ('" & (txt_codigo_subfamilia_2.Text) & "','" & (txt_codigo_subfamilia.Text) & "','" & (txt_nombre_subfamilia_dos.Text) & "','" & (Form_menu_principal.dtp_fecha.Text) & "')"
                DA.SelectCommand = SC
                DA.Fill(DT)
        ...
        ElseIf VarSeleccion = 2 Then
            ...
            SC.Connection = conexion
            SC.CommandText = "UPDATE SUBFAMILIA_DOS SET nombre_subfamilia='" & (txt_nombre_subfamilia_dos.Text) & "',fecha_modificacion='" & (Form_menu_principal.dtp_fecha.Text) & "' WHERE cod_auto = '" & (txt_codigo_subfamilia_2.Text) & "'"
            DA.SelectCommand = SC
            DA.Fill(DT)
    ...
    Private Sub btn_eliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_eliminar.Click
        ...
        If valormensaje = vbYes Then
            ...
            SC.Connection = conexion
            SC.CommandText = "INSERT INTO `registros_eliminados` (`registro`, `codigo`, `fecha`, `usuario_responsable`) VALUES ('SUBFAMILIA DOS', '" & (txt_codigo_subfamilia_2.Text) & "', '" & (Form_menu_principal.dtp_fecha.Text) & "', '" & (miusuario) & "');"
            DA.SelectCommand = SC
            DA.Fill(DT)
