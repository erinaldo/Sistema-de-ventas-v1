    ...
    Private Sub btn_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        ...
        If txt_codigo.Text <> "" And txt_nombre.Text <> "" And txt_cantidad_final.Text <> "" Then
            Try
                ...
                SC.Connection = conexion
                SC.CommandText = "insert into detalle_total (n_total, TIPO, cod_producto, nombre, valor_unitario, cantidad, descuento, neto, iva, subtotal, total, movimiento) values(" & (txt_nro_ajuste.Text) & ", '" & ("AJUSTE POR: " & miusuario) & "', '" & (txt_codigo.Text) & "','" & (txt_nombre.Text) & "'," & (txt_precio.Text) & "," & (txt_cantidad_final.Text) & ",'0','0','0','0','0','AJUSTE')"
                DA.SelectCommand = SC
                DA.Fill(DT)
        ...
        If txt_codigo_3.Text <> "" And txt_nombre_3.Text <> "" And txt_cantidad_final_3.Text <> "" Then
            Try
                ...
                SC.Connection = conexion
                SC.CommandText = "insert into detalle_total (n_total, TIPO, cod_producto, nombre, valor_unitario, cantidad, descuento, neto, iva, subtotal, total, movimiento) values(" & (txt_nro_ajuste.Text) & ", '" & ("AJUSTE POR: " & miusuario) & "', '" & (txt_codigo_3.Text) & "','" & (txt_nombre_3.Text) & "'," & (txt_precio_3.Text) & "," & (txt_cantidad_final_3.Text) & ",'0','0','0','0','0','AJUSTE')"
                DA.SelectCommand = SC
                DA.Fill(DT)
