...
Public Class Form_deudores
    ...
    Sub mostrar_malla()
        ...
        SC.CommandText = "select CREDITOS.rut_cliente as 'RUT', clientes.nombre_cliente as 'NOMBRE', clientes.direccion_cliente as 'DIRECCION', clientes.COMUNA_cliente as 'CIUDAD', clientes.telefono_cliente as 'TELEFONO', creditos.numero_cuota as 'CUOTA', creditos.total_cuotas as 'CUOTAS', creditos.fecha_venta as 'EMISION', creditos.fecha_vencimiento as 'VENCIMIENTO', creditos.saldo as 'SALDO'  from  creditos, clientes where creditos.rut_cliente=clientes.rut_cliente and creditos.saldo > 0 and  creditos.fecha_vencimiento >='" & (mifecha2) & "' and creditos.fecha_vencimiento <= '" & (mifecha4) & "' GROUP BY CREDITOS.COD_AUTO order by nombre_cliente, fecha_vencimiento;"
    ...
    Sub calcular_total()
        ...
        txt_total.Text = 0
        For i = 0 To grilla_deudores.Rows.Count - 1
            totalgrilla = Val(grilla_deudores.Rows(i).Cells(9).Value.ToString)
