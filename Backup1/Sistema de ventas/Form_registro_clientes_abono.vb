...
Public Class Form_registro_clientes_abono
    ...
    Sub grabar_pedido()
        ...
        SC.Connection = conexion
        SC.CommandText = "insert into pedido (codigo_pedido, nombre_cliente,telefono_cliente, abono, fecha_pedido, usuario_responsable, rut_cliente, hora) values('" & (Form_pedidos.txt_codigo_pedido.Text) & "', '" & (txt_nombre_cliente.Text) & "', '" & (txt_telefono_cliente.Text) & "', '" & (txt_abono.Text) & "', '" & (Form_pedidos.dtp_fecha_pedido.Text) & "','" & (miusuario) & "', '-', '" & (Form_menu_principal.lbl_hora.Text) & "')"
        DA.SelectCommand = SC
        DA.Fill(DT)
    ...
    Private Sub DocImprimir_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        e.Graphics.DrawString("ABONO PARA ENCARGAR REPUESTO", Font2, Brushes.Black, 15, 165)

        e.Graphics.DrawString("COD. PEDIDO", Font3, Brushes.Black, 0, 195)
        e.Graphics.DrawString(":", Font3, Brushes.Black, 75, 195)
        e.Graphics.DrawString(Form_pedidos.txt_codigo_pedido.Text, Font3, Brushes.Black, 80, 195)
        e.Graphics.DrawString("FECHA", Font3, Brushes.Black, 0, 210)
        e.Graphics.DrawString(":", Font3, Brushes.Black, 75, 210)
        e.Graphics.DrawString(Form_pedidos.dtp_fecha_pedido.Text, Font3, Brushes.Black, 80, 210)
        e.Graphics.DrawString("CLIENTE", Font3, Brushes.Black, 0, 225)
        e.Graphics.DrawString(":", Font3, Brushes.Black, 75, 225)
        e.Graphics.DrawString(txt_nombre_cliente.Text, Font3, Brushes.Black, 80, 225)
        e.Graphics.DrawString("TELEFONO", Font3, Brushes.Black, 0, 240)
        e.Graphics.DrawString(":", Font3, Brushes.Black, 75, 240)
        e.Graphics.DrawString(txt_telefono_cliente.Text, Font3, Brushes.Black, 80, 240)
        'e.Graphics.DrawString("DIRECCION", Font3, Brushes.Black, 0, 255)
        'e.Graphics.DrawString(":", Font3, Brushes.Black, 75, 255)
        'e.Graphics.DrawString(txt_direccion_cliente.Text, Font1, Brushes.Black, 80, 255)
        e.Graphics.DrawString("VENDEDOR", Font3, Brushes.Black, 0, 255)
        e.Graphics.DrawString(":", Font3, Brushes.Black, 75, 255)
        e.Graphics.DrawString(minombre, Font3, Brushes.Black, 80, 255)
        e.Graphics.DrawString("TELEFONO", Font3, Brushes.Black, 0, 270)
        e.Graphics.DrawString(":", Font3, Brushes.Black, 75, 270)
        e.Graphics.DrawString(mitelefono, Font3, Brushes.Black, 80, 270)
        e.Graphics.DrawString("ABONO", Font3, Brushes.Black, 0, 285)
        e.Graphics.DrawString(":", Font3, Brushes.Black, 75, 285)
        e.Graphics.DrawString("$ " & txt_abono.Text, Font3, Brushes.Black, 80, 285)
        e.Graphics.DrawString("DESGLOSE", Font3, Brushes.Black, 0, 300)
        e.Graphics.DrawString(":", Font3, Brushes.Black, 75, 300)
        e.Graphics.DrawString(txt_desglose.Text, Font3, Brushes.Black, 80, 300)
        ...
        For i = 0 To Form_pedidos.grilla_pedidos.Rows.Count - 1
            ...
            e.Graphics.DrawString(codigo_producto, Font3, Brushes.Gray, 0, 350 + (i * 15))
            e.Graphics.DrawString(descripcion_caracteres, Font3, Brushes.Gray, 65, 350 + (i * 15))
            e.Graphics.DrawString(cantidad, Font3, Brushes.Gray, 218, 350 + (i * 15), format1)
            e.Graphics.DrawString(fecha_llegada, Font3, Brushes.Gray, 230, 350 + (i * 15))
        Next
        ...
        Dim rect12 As New Rectangle(10, var_grilla + 600, 275, 15)
        ...
        Dim rect7 As New Rectangle(10, var_grilla + 630, 275, 15)
        Dim rect8 As New Rectangle(10, var_grilla + 645, 275, 15)
        Dim rect9 As New Rectangle(10, var_grilla + 660, 275, 15)
        Dim rect10 As New Rectangle(10, var_grilla + 675, 275, 15)
        Dim rect11 As New Rectangle(10, var_grilla + 690, 275, 15)
        ...
        e.Graphics.DrawString("-", Font3, Brushes.Gray, 135, var_grilla + 750)
    End Sub
