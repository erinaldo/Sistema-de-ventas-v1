...
Public Class Form_buscador_clientes_para_asociar
    Dim consulta_busqueda As String

    Private Sub Form_buscar_clientes_para_asociar_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_asociar_clientes_a_empresas.WindowState = FormWindowState.Normal
        Form_asociar_clientes_a_empresas.Enabled = True
    End Sub

    Private Sub Form_buscar_clientes_para_asociar_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_buscar_clientes_para_asociar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargar_logo()
    ...
    Private Sub migrilla_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles migrilla.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            If migrilla.Rows.Count <= 0 Then
                Me.Close()
                Form_asociar_clientes_a_empresas.txt_rut_empresa.Focus()
                Me.Close()
            Else
                codigo = migrilla.CurrentRow.Cells(0).Value
                Form_asociar_clientes_a_empresas.limpiar()
                Form_asociar_clientes_a_empresas.txt_rut_empresa.Text = codigo
                mostrar_datos_clientes()
                Form_asociar_clientes_a_empresas.txt_rut_empresa.Focus()
                Me.Close()
            End If
