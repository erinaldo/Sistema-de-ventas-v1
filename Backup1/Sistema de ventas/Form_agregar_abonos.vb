    ...
    Private Sub DocImprimir_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles Pd.PrintPage
        ...
        If txt_rut.Text.Contains("PROPIEDAD") = False Then
            ...
            For i = 0 To grilla_abono.Rows.Count - 1
                ...
                e.Graphics.DrawString(detalle_saldo, Font_texto_detalle, Brushes.Black, margen_izquierdo + 285, margen_superior + 390 + (i * multiplicador_lineas), format1)
            Next

            numero_lineas = ((grilla_abono.Rows.Count - 1) * multiplicador_lineas)

            e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 1, margen_superior + numero_lineas + 405, margen_izquierdo + 295, margen_superior + numero_lineas + 405)
            ...
            e.Graphics.DrawString("TOTAL INGRESO: " & txt_total_abono_millar.Text, Font_texto_totales, Brushes.Black, margen_izquierdo + 295, margen_superior + numero_lineas + 425, format1)

            Dim rect_guion_final As New Rectangle(margen_izquierdo + 10, margen_superior + numero_lineas + 350, margen_izquierdo + 270, margen_superior + numero_lineas + 15)
        ...
        If txt_rut.Text.Contains("PROPIEDAD") = True Then
            ...
            Try
                e.Graphics.DrawImage(Bytes_Imagen(Imagen_propiedad), -74, 0, 440, 70)
            Catch
            End Try
