...
Public Class Form_stock
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("RUT", Font_campos_superiores, Brushes.Black, margen_izquierdo + 50, margen_superior + 119)
        e.Graphics.DrawString("TELEFONO", Font_campos_superiores, Brushes.Black, margen_izquierdo + 50, margen_superior + 130)
        e.Graphics.DrawString(":", Font_campos_superiores, Brushes.Black, margen_izquierdo + 110, margen_superior + 119)
        e.Graphics.DrawString(":", Font_campos_superiores, Brushes.Black, margen_izquierdo + 110, margen_superior + 130)
        e.Graphics.DrawString(txt_rut_proveedor.Text, Font_campos_superiores, Brushes.Black, margen_izquierdo + 120, margen_superior + 119)
        e.Graphics.DrawString(txt_telefono.Text, Font_campos_superiores, Brushes.Black, margen_izquierdo + 120, margen_superior + 130)

        e.Graphics.DrawString("NOMBRE", Font_campos_superiores, Brushes.Black, margen_izquierdo + 400, margen_superior + 119)
        e.Graphics.DrawString("DIRECCION", Font_campos_superiores, Brushes.Black, margen_izquierdo + 400, margen_superior + 130)
        e.Graphics.DrawString(":", Font_campos_superiores, Brushes.Black, margen_izquierdo + 470, margen_superior + 119)
        e.Graphics.DrawString(":", Font_campos_superiores, Brushes.Black, margen_izquierdo + 470, margen_superior + 130)
        e.Graphics.DrawString(txt_nombre_proveedor.Text, Font_campos_superiores, Brushes.Black, margen_izquierdo + 480, margen_superior + 119)
        e.Graphics.DrawString(txt_direccion.Text, Font_campos_superiores, Brushes.Black, margen_izquierdo + 480, margen_superior + 130)

        e.Graphics.DrawString("CODIGO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 50, margen_superior + 160)
        e.Graphics.DrawString("NOMBRE", Font_titulo_columna, Brushes.Black, margen_izquierdo + 100, margen_superior + 160)
        e.Graphics.DrawString("MARCA", Font_titulo_columna, Brushes.Black, margen_izquierdo + 265, margen_superior + 160)
        e.Graphics.DrawString("NRO. TECNICO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 370, margen_superior + 160)
        e.Graphics.DrawString("CANT.", Font_titulo_columna, Brushes.Black, margen_izquierdo + 575, margen_superior + 160, format1)
        e.Graphics.DrawString("MIN.", Font_titulo_columna, Brushes.Black, margen_izquierdo + 625, margen_superior + 160, format1)
        e.Graphics.DrawString("COSTO", Font_titulo_columna, Brushes.Black, margen_izquierdo + 685, margen_superior + 160, format1)
        e.Graphics.DrawString("PROVEEDOR", Font_titulo_columna, Brushes.Black, margen_izquierdo + 700, margen_superior + 160)

        e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 40, margen_superior + 175, margen_izquierdo + 865, margen_superior + 175)
        ...
        For i = numero_lineas_total To grilla_stock.Rows.Count - 1
            ...
            e.Graphics.DrawString(Varcodigo, Font_texto_impresion, Brushes.Black, margen_izquierdo + 50, margen_superior + 180 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(Varnombre, Font_texto_impresion, Brushes.Black, margen_izquierdo + 100, margen_superior + 180 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(Varmarca, Font_texto_impresion, Brushes.Black, margen_izquierdo + 265, margen_superior + 180 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(varnumerotecnico, Font_texto_impresion, Brushes.Black, margen_izquierdo + 370, margen_superior + 180 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(varcantidad, Font_texto_impresion, Brushes.Black, margen_izquierdo + 575, margen_superior + 180 + (numero_lineas * multiplicador_lineas), format1)
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(varminima, Font_texto_impresion, Brushes.Black, margen_izquierdo + 625, margen_superior + 180 + (numero_lineas * multiplicador_lineas), format1)
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(varcosto, Font_texto_impresion, Brushes.Black, margen_izquierdo + 685, margen_superior + 180 + (numero_lineas * multiplicador_lineas), format1)
            '***************************************************************************************************************************************************

            e.Graphics.DrawString(varproveedor, Font_texto_impresion, Brushes.Black, margen_izquierdo + 700, margen_superior + 180 + (numero_lineas * multiplicador_lineas))
            '***************************************************************************************************************************************************
            ...
            If numero_lineas > 80 Then
                'Linea horizontal
                e.Graphics.DrawLine(Pens.Black, margen_izquierdo + 40, margen_superior + 185 + (numero_lineas * multiplicador_lineas), margen_izquierdo + 865, margen_superior + 185 + (numero_lineas * multiplicador_lineas))
                '***************************************************************************************************************************************************
