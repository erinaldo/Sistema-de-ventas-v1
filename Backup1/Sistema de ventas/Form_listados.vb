Public Class Form_listados
    ...
    Sub mostrar_malla_proveedor()
        ...
        DS.Clear()
        SC.Connection = conexion
        SC.CommandText = "select * from proveedor order by " & (ordenar_por) & ""
        DA.SelectCommand = SC
        DA.Fill(DT)
        DS.Tables.Add(DT)
        grilla_libro_compras.Rows.Clear()
                ...
                grilla_libro_compras.Rows.Add(DS.Tables(DT.TableName).Rows(i).Item("cod_auto"), _
                                               DS.Tables(DT.TableName).Rows(i).Item("n_creditos"), _
                                                DS.Tables(DT.TableName).Rows(i).Item("tipo_detalle"), _
                                                 DS.Tables(DT.TableName).Rows(i).Item("cod_cliente"), _
                                                  DS.Tables(DT.TableName).Rows(i).Item("rut_cliente"), _
                                                      ...
                                                      DS.Tables(DT.TableName).Rows(i).Item("condiciones"), _
                                                       DS.Tables(DT.TableName).Rows(i).Item("estado"), _
                                                        DS.Tables(DT.TableName).Rows(i).Item("recinto"), _
                                                         DS.Tables(DT.TableName).Rows(i).Item("fecha_vencimiento"), _
                                                          DS.Tables(DT.TableName).Rows(i).Item("fecha_pago"), _
