...
Public Class Form_autorizacion_anular

    Private Sub Form_autorizacion_anular_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Form_anular_documentos.Enabled = True
        Form_anular_documentos.WindowState = FormWindowState.Normal



        Form_anular_documentos.combo_documentos.Enabled = True
        Form_anular_documentos.txt_nro_doc.Enabled = True
        Form_anular_documentos.txt_nro_doc.Focus()

        Form_anular_documentos.lbl_mensaje.Visible = False
        Form_anular_documentos.Enabled = True
    ...
    Private Sub Form_autorizacion_anular_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
    ...
    Private Sub Form_autorizacion_anular_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_aceptar.Click
        ...
        If DS.Tables(DT.TableName).Rows.Count > 0 Then
            If Form_anular_documentos.combo_documentos.SelectedItem = "BOLETA" Or Form_anular_documentos.combo_documentos.SelectedItem = "VALE DE CAMBIO" Then
                Form_anular_documentos.devolver_productos()
                Form_anular_documentos.anulacion_documentos()
                Form_anular_documentos.anular_cambio()
            Else
                Form_anular_documentos.devolver_productos()
                Form_anular_documentos.anulacion_documentos()
            End If
            ...
            SC.Connection = conexion
            SC.CommandText = "insert into bitacora_de_cambios (procedencia, detalle, codigo, fecha, TIPO, usuario_responsable) values('DOCUMENTOS','ANULACION DE DOCUMENTOS','" & (Form_anular_documentos.combo_documentos.Text & " " & Form_anular_documentos.txt_nro_doc.Text) & "','" & (Form_menu_principal.dtp_fecha.Text) & "','ANULACION','" & (miusuario) & "')"
            DA.SelectCommand = SC
            DA.Fill(DT)
